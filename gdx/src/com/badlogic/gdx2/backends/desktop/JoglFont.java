...
import com.badlogic.gdx2.math.Rectangle;
...
final class JoglFont extends Font 
{
	...
	JoglFont( com.badlogic.gdx2.Graphics graphics, String fontName, int size, FontStyle style )
	{	
		super( graphics );
	...
	JoglFont( com.badlogic.gdx2.Graphics graphics, InputStream in, int size, FontStyle style )
	{
		super( graphics );
