 ...
 * vertices composed of 3D positions, normals, colors and texture 
 ...
 * methods before you define a vertex. Internally all vertex attributes
 * are stored in direct {@link FloatBuffer}s.
 * </p> 
 * 
 * <p>
 * For more fine grained control you can directly access the 
 * direct FloatBuffers holding the vertex data. If you do so you have to 
...
public interface Mesh 
{
	 ...
	 * 
	 * @param unit the texture unit this coordinates belong to starting at 0
	 * @param u The u component
	 * @param v The v component
	 */
	public void texCoord( int unit, float u, float v );
	...
	/**
	 * @return the FloatBuffer holding the vertex positions
	 */
	public FloatBuffer getVertices( );
	
	/**
	 * @return the FloatBuffer holding the vertex normals
	 */
	public float[] getNormals( );
	
	/**
	 * @param unit the texture unit to retrieve the FloatBuffer for
	 * @return the Floatbuffer holding the texture coordinates of the given unit
	 */
	public float[] getUV( int unit );
	
	/**
	 * @return the FloatBuffer holding the colors
	 */
