 ...
 * 
 * <h2>Style</h2>
 * An ImageToggleButton is a {@link Widget} displaying a background {@link NinePatch} as well as
 * image in form of a {@link TextureRegion}. The style is defined via an instance
 * of {@link ImageToggleButtonStyle}, which can be either done programmatically or via a {@link Skin}.</p>
 * 
 ...
 * 
 * <ul>
 * <li>The <code>name</code> attribute defines the name of the style which you can later use with {@link Skin#newImageToggleButton(String, TextureRegion, String)}.</li>
...
public class ImageToggleButton extends Widget {
	...
	/**
	 * Creates a new image toggle button. The size is determined by the image's size
	...
	/**
	 * Sets the image's TextureRegion. Invalidates all parents. Keeps
	 * the previously set image size.
