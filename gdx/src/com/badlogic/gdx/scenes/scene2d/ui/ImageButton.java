 ...
 * 
 * <h2>Layout</h2> The (preferred) width and height of an ImageButton are derrived from the border patches in the background
 * {@link NinePatch} as well as the width and height of the TextureRegion of the image displayed inside the Imagebutton. Use
 ...
 * 
 * <h2>Style</h2> An ImageButton is a {@link Widget} displaying a background {@link NinePatch} as well as image in form of a
 * {@link TextureRegion}. The style is defined via an instance of {@link ImageButtonStyle}, which can be either done
 ...
 * {@link Skin#newImageButton(String, TextureRegion, String)}.</li>
...
public class ImageButton extends Widget {
	...
	/** Sets the image's {@link TextureRegion} to be used by this button. Invalidates all parents.
