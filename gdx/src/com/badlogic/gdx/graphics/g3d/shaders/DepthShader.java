...
public class DepthShader extends DefaultShader {
	...
	public boolean canRender (Renderable renderable) {
		...
		final Attributes attributes = combineAttributes(renderable);
		if (attributes.has(BlendingAttribute.Type) && ((attributesMask & BlendingAttribute.Type) != BlendingAttribute.Type)) return false;
		if (attributes.has(TextureAttribute.Diffuse) != ((attributesMask & TextureAttribute.Diffuse) == TextureAttribute.Diffuse)) return false;
