...
<kalle_h> hard to make it work for every cases
	...
	public void render (final Renderable renderable) {
		...
		if (currentTransform != renderable.worldTransform) {
			set(u_modelTrans, currentTransform = renderable.worldTransform);
			set(u_normalMatrix, normalMatrix.set(currentTransform));
		}
		if (localTransform != renderable.localTransform)
			set(u_localTrans, localTransform = renderable.localTransform);
