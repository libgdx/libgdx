...
public class ParticleShader extends BaseShader {
	public static class Config {
		...
		public BillboardRenderer.AlignMode align = BillboardRenderer.AlignMode.Screen;
		public Config() { }
		public Config(BillboardRenderer.AlignMode align) {
			this.align = align;
		}
	...
	public static String createPrefix(final Renderable renderable, final Config config) {
		String prefix = "";
		if(config.align == BillboardRenderer.AlignMode.Screen) 
			prefix += "#define screenFacing\n";
		else if(config.align == BillboardRenderer.AlignMode.ViewPoint) 
			prefix += "#define viewPointFacing\n";
		else if(config.align == BillboardRenderer.AlignMode.ParticleDirection) 
