...
// start
	...
	public static class CircularMotion extends Angular {
		FloatChannel positionChannel;
		...
		public void activateParticles (int startIndex, int count) {
			...
			for (int i = startIndex; i < startIndex + count; ++i) {
				...
				TMP_V1.set(positionChannel.data[posI + ParticleChannels.XOffset], positionChannel.data[posI
					+ ParticleChannels.YOffset], positionChannel.data[posI + ParticleChannels.ZOffset]);
				TMP_V3.set(cosTheta * sinPhi, cosPhi, sinTheta * sinPhi);
		...
		public void update () {
			for (int i = 0, l = ParticleChannels.LifePercentOffset, s = 0, a = 0, positionOffset = 0, c = i
				+ controller.particles.size * accelerationChannel.strideSize; i < c; s += strengthChannel.strideSize, i += accelerationChannel.strideSize, a += angularChannel.strideSize, l += lifeChannel.strideSize, positionOffset += positionChannel.strideSize) {
