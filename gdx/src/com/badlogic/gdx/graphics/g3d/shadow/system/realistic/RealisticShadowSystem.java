 ...
 * only one time for each light and then render the scene. This system implements EnvironmentListener so the lights are added when
 * you add them in the environment.
 * @author realitix */
