...
public class IntAttribute extends Attribute {
	 ...
	 * @param value cull face value, possible values are 0 (render both faces), GL_FRONT_AND_BACK (render nothing), GL_BACK (render front faces only), GL_FRONT (render back faces only), or -1 to inherit default
	 * @return an attribute */
