...
public class NodeAnimation {
	...
	public @Nullable Array<NodeKeyframe<Vector3>> translation = null;
	/** the rotation keyframes if any (might be null), sorted by time ascending **/
	public @Nullable Array<NodeKeyframe<Quaternion>> rotation = null;
	/** the scaling keyframes if any (might be null), sorted by time ascending **/
	public @Nullable Array<NodeKeyframe<Vector3>> scaling = null;
}
