...
/** A PolyBatch is an extension of the Batch interface that provides additional render methods specifically for rendering
 * polygons
 *
 * <p>
 * @author mzechner
 * @author Nathan Sweet */
public interface PolyBatch extends Batch {
