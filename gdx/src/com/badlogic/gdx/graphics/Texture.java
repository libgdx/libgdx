...
public class Texture extends GLTexture {
	...
	public enum TextureFilter {
		/**
		 * Fetch the nearest texel that best map to the pixel on screen.
		 */
		...
		/**
		 * same as MipMapLinearLinear
		 * @see MipMapLinearLinear
		 */
		 ...
		 * sample the nearest texel from each of the two images, combining them to the final output pixel.
		 */
		MipMapNearestLinear(GL20.GL_NEAREST_MIPMAP_LINEAR),

		/**
		 * Fetch the two best fitting images from the mip map chain and
		 * then sample the four nearest texels from each of the two images, combining them to the final output pixel.
		 */
