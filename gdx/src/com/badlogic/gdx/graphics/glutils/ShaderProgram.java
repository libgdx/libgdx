...
public class ShaderProgram implements Disposable {
	...
	/** application this shader is managed by and resolves GL from **/
	private final Application app;

	private GL20 gl20 () {
		return app.getGraphics().getGL20();
	}
	...
	public ShaderProgram (String vertexShader, String fragmentShader) {
		this(Gdx.app, vertexShader, fragmentShader);
	}

	/** Constructs a new ShaderProgram and immediately compiles it.
	 *
	 * @param app the application used to resolve the current GL20 instance and manage this shader
	 * @param vertexShader the vertex shader
	 * @param fragmentShader the fragment shader */
	public ShaderProgram (Application app, String vertexShader, String fragmentShader) {
	...
	public ShaderProgram (Application app, FileHandle vertexShader, FileHandle fragmentShader) {
		this(app, vertexShader.readString(), fragmentShader.readString());
	}
...
// }
	...
	public void dispose () {
		...
		if (shaders.get(app) != null) shaders.get(app).removeValue(this, true);
	}
	...
	public static int getNumManagedShaderPrograms () {
		return getNumManagedShaderPrograms(Gdx.app);
	}

	/** @return the number of managed shader programs currently loaded for the given application */
	...
	private void fetchUniforms () {
		...
		for (int i = 0; i < numUniforms; i++) {
			...
			params.put(0, 1);
			((Buffer)type).clear();
			String name = gl.glGetActiveUniform(program, i, params, type);
	...
	private void fetchAttributes () {
		...
		for (int i = 0; i < numAttributes; i++) {
			...
			params.put(0, 1);
			((Buffer)type).clear();
			String name = gl.glGetActiveAttrib(program, i, params, type);
