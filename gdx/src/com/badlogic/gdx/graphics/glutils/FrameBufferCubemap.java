 ...
 * } <br />
 * frameBuffer.end(); <br />
 * Cubemap cubemap = frameBuffer.getColorBufferTexture();
 * </p>
 *
 * @author realitix */
public class FrameBufferCubemap implements Disposable {
	 ...
	 * @param hasDepth
	 */
	public FrameBufferCubemap (Pixmap.Format format, int width, int height, int depth, boolean hasDepth) {
		this(format, width, height, depth, hasDepth, false);
	}
	 ...
	 * @param depth the depth of the cubemap in pixels
	...
	public FrameBufferCubemap (Pixmap.Format format, int width, int height, int depth, boolean hasDepth, boolean hasStencil) {
		this.width = width;
		this.height = height;
		this.depth = depth;
		this.format = format;
	...
	protected void setupTexture () {
		colorTexture = new Cubemap(width, height, depth, format);
	...
	private static void addManagedFrameBuffer (Application app, FrameBufferCubemap frameBuffer) {
		Array<FrameBufferCubemap> managedResources = buffers.get(app);
		if (managedResources == null) managedResources = new Array<FrameBufferCubemap>();
	...
	public static void invalidateAllFrameBuffers (Application app) {
		...
		Array<FrameBufferCubemap> bufferArray = buffers.get(app);
