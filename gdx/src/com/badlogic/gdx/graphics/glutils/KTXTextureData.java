...
public class KTXTextureData implements TextureData {
	...
	public void consumeCustomData (int target) {
		...
		} else if (numberOfFaces != 1) throw new GdxRuntimeException("numberOfFaces must be either 1 or 6");
		...
		if (target == GL20.GL_TEXTURE_CUBE_MAP) target = GL20.GL_TEXTURE_CUBE_MAP_POSITIVE_X;
