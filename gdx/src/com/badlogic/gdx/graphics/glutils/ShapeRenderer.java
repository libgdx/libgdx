...
public class ShapeRenderer implements Disposable {
	...
	public void polyline (float[] vertices) {
	  ...
	  * If not and autoShapeType is enabled, it flushes the batch and changes the shape type.
	  * The batch is also flushed, when the matrix has been changed or not enough vertices remain.
	  *
