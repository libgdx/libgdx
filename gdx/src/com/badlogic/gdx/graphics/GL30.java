...
//    );
    ...
    public boolean glUnmapBuffer(
        int target
    );

    // C function void glGetBufferPointerv ( GLenum target, GLenum pname, GLvoid** params )

    public java.nio.Buffer glGetBufferPointerv(
        int target,
        int pname
    );
...
//    );
    ...
    public boolean glIsVertexArray(
        int array
    );
//
...
//    );
    ...
    public int glGetFragDataLocation(
        int program,
        String name
    );
...
//    );
    ...
    public int glGetUniformBlockIndex(
        int program,
...
//    );
    ...
    public boolean glIsTransformFeedback(
        int id
    );
