...
/**
 * Loads an OCT file as found in many of Paul Nettle's demos. See the source at
...
public class OctLoader {
	private static class OctVert {
		public float tu, tv;
		@SuppressWarnings("unused") public float lu, lv;
		public float x, y, z;
	}
	...
	private static class OctFace {
		public int start;
		public int num;
		@SuppressWarnings("unused") public int id;
		@SuppressWarnings("unused") public int lid;
