...
/**
 * This interface encapsulates the creation and management of audio resources. It
 * allows you to get direct access to the audio hardware via the
 ...
 * {@link ApplicationListener#pause()} method is called, and automatically resumed
 * when the {@link ApplicationListener#resume()} method is called.
 * </p>
 * 
 * @author mzechner
 * 
...
public interface Audio {
	/**
	 * Creates a new {@link AudioDevice} either in 44.1khz mono or stereo mode.
	 * The AudioDevice has to be disposed via its {@link AudioDevice#dispose()}
	 * method when it is no longer used.
	 * 
	 * @param isMono
	 *            whether the AudioDevice should be in mono or stereo mode
	 * @return the AudioDevice
	 * 
	 * @throws GdxRuntimeException
	 *             in case the device could not be created
	 */
	 ...
	 * 
	 * @param samplingRate
	 *            the sampling rate in Herz
	 * @param isMono
	 *            whether the recorder records in mono or stereo
	 * @return the AudioRecorder
	 * 
	 * @throws GdxRuntimeException
	 *             in case the recorder could not be created
	 */
	 ...
	 * @throws GdxRuntimeException
	 *             in case the sound could not be loaded
	 */
	 ...
	 * {@link Music#dispose()} method. Music instances are automatically paused
	 * when {@link ApplicationListener#pause()} is called and resumed when 
	 ...
	 * @throws GdxRuntimeException
	 *             in case the music could not be loaded
	 */
