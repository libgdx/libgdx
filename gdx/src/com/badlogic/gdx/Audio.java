...
/**
 * This interface encapsulates the creation and managment of audio resources. It allows you to create direct access links to the
 * audio hardware via the {@link AudioDevice} and {@link AudioRecorder} interfaces, create sound effects via the {@link Sound}
