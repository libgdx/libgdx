...
public class AudioTools {
	 ...
	 * numSamples elements available in both buffers. Source and target get read and written to from offset 0.
	 * 
	 ...
	 * written from position 0 up to numSamples.
	 * 
	 * @param source the source buffer
	 * @param target the target buffer
	 ...
	 * is the current spectrum spectrum A the last spectrum
	 * 
