...
public abstract class AbstractGraphics implements Graphics {
	...
	/** Calculates and returns the screen density based on the pixel-per-inch value along the X-axis. The density is derived by
	 * dividing the PPI by a standard 160 PPI, and defaults to 1 if PPI is invalid.
	...
	/** Computes and returns the scaling factor for the back buffer compared to the display width. This is the ratio of the back
	 * buffer width to the display width.
