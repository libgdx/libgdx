...
/**
 * This interface encapsulates the access of internal, external and absolute files.
 ...
 * relative to the user home directory. Absolute files are just that, fully qualified
 * filenames. To ensure portability across platforms use absolute files only when absolutely
 * necessary.
 * 
 * @author mzechner
 *
...
public interface Files 
{
	 ...
	 * and absolute. Internal files are located in the asset directory
	...
	/**
	 * Returns an {@link InputStream} to the given file. If type is equal
	 * to {@link FileType.Internal} an internal file will be opened. On Android
	 ...
	 * {@link FileType.External} an external file will be opened. On Android this
	 * is relative to the SD-card, on the desktop it is relative to the
	 * current user's home directory. If type is equal to {@link FileType.Absolut}
	...
	/**
	 * Returns and {@link OutputStream} to the given  file. If
	 * the file does not exist it is created. If the file
	 * exists it will be overwritten. If type is equal
	 * to {@link FileType.Internal} null will be returned as on Android assets can not be written. If type is equal to
	 * {@link FileType.External} an external file will be opened. On Android this
	 * is relative to the SD-card, on the desktop it is relative to the
	 * current user's home directory. If type is equal to {@link FileType.Absolut}
	 ...
	 * to {@link FileType.Internal} false will be returned as on Android new directories in the asset directory can not be created. If type is equal to
	 * {@link FileType.External} an external directory will be created. On Android this
	 * is relative to the SD-card, on the desktop it is relative to the
	 * current user's home directory. If type is equal to {@link FileType.Absolut}
	 * the directory is interpreted as an absolute directory name.
	 * 
	 ...
	 * to {@link FileType.Internal} an internal directory will be listed. On Android
	 * this is relative to the assets directory, on the desktop it is 
	 * relative to the applications root directory. If type is equal to
	 * {@link FileType.External} an external directory will be listed. On Android this
	 * is relative to the SD-card, on the desktop it is relative to the
	 * current user's home directory. If type is equal to {@link FileType.Absolut}
	...
	/**
	 * Returns a {@link FileHandle} object for a file. If type is equal
	 * to {@link FileType.Internal} an internal file will be opened. On Android
	 * this is relative to the assets directory, on the desktop it is 
	 * relative to the applications root directory. If type is equal to
	 * {@link FileType.External} an external file will be opened. On Android this
