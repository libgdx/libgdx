 ...
 * java default random show an average difference of 10 ms on an input of 1 millions of floating point numbers. To use it inside
 * the code one can simply assign an instance of this class to {@link MathUtils#random} member at application setup and generate
