...
public class FloatCounter {
	...
	/** Creates a string containing values: count, total, min, max, average */
	public StringBuilder toString (final StringBuilder sb) {
		sb.append("count: ").append(count);
		sb.append(", total: ");
		addFormattedFloat(total, sb);
		sb.append(", min: ");
		addFormattedFloat(min, sb);
		sb.append(", max: ");
		addFormattedFloat(max, sb);
		sb.append(", average: ");
		addFormattedFloat(average, sb);
		return sb;
	}

	private void addFormattedFloat (float f, StringBuilder sb) {
		String unit = " sec";
		if (f < 0.00000001) {
			f *= 1000000000;
			unit = " ns";
