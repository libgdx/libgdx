...
public class Vector3 implements Serializable, Vector<Vector3> {
	...
	/** @return The euclidian length of a vector with values x, y and z, does not instantiate a Vector object*/
	...
	/** @return The euclidian distance between the two specified vectors, does not instantiate Vector3 objects */
	...
	/** @return the squared distance between the given points, does not insantiate Vector3 objects */
	...
	@Override
	public Vector3 mulAdd(Vector3 v, float scalar) {
		this.x += v.x * scalar;
		this.y += v.y * scalar;
		this.z += v.z * scalar;
		return this;
