...
public class HexagonalTiledMapRenderer extends BatchTiledMapRenderer {
	...
	public HexagonalTiledMapRenderer (TiledMap map, float unitScaleX, float unitScaleY) {
	...
	public HexagonalTiledMapRenderer (TiledMap map, float unitScaleX, float unitScaleY, Batch batch) {
	...
	public void renderTileLayer (TiledMapTileLayer layer) {
		...
		//TODO what unitScale to use her??? unitScaleX or unitScaleY
		final float layerHexLength = hexSideLength * unitScaleX;
