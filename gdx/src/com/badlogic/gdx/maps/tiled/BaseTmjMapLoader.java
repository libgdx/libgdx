...
public abstract class BaseTmjMapLoader<P extends BaseTmjMapLoader.Parameters> extends AsynchronousAssetLoader<TiledMap, P> {
     ...
     *
     * @return the map of the ids to {@link MapObject}, or null if {@link #loadTiledMap(FileHandle, BaseTmjMapLoader.Parameters, ImageResolver)}
    ...
    private AnimatedTiledMapTile createAnimatedTile(TiledMapTileSet tileSet, TiledMapTile tile, JsonValue
            tileElement,
                                                    int firstgid) {
