...
/**
 * Provides methods to sort arrays or objects. Sorting requires working memory and this class allows that memory to be reused to
...
public class Sort {
	...
	public <T extends Comparable<T>> void sort (ArrayPool<T> a) {
		if (comparableTimSort == null) comparableTimSort = new ComparableTimSort();
		comparableTimSort.doSort(a.items, 0, a.size);
	}
