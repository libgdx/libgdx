 ...
 * java.util.HashMap uses chained entries and allocates on put. This class also avoids the boxing that occurs with
 * HashMap<Integer, T>.<br>
 * <br>
...
public class IntMap<V> {
	...
	public IntMap (int initialCapacity, float loadFactor) {
		...
		keyTable = new int[capacity + EXTRA];
	...
	public V put (int key, V value) {
		...
		int index = key & mask;
		while (true) {
			int existingKey = keyTable[index];
