...
public class AssetManager implements Disposable {
	...
	/**
	 * Removes the asset and all its dependencies if they are not used by
	 * other assets.
	...
	/**
	 * Removes a task from the preloadQueue and adds it to the task stack. If the
	 * asset is already loaded (which can happen if it was a dependency of a previously
	 * loaded asset) and if it is a {@link ReferenceCountedAsset} its reference count
	 * will be increased.
	 */
	...
	/**
	 * Sets an {@link AssetErrorListener} to be invoked in case loading an
	 * asset failed.
