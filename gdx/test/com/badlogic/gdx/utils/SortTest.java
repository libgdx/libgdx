...
public class SortTest {
    ...
    @Test
    public void
    testSortArrayComparableWithPreExistingComparableTimSort () throws
        Exception {
    ...
    @Test
    public void testSortArrayComparableWithNullComparableTimSort ()
        throws Exception {
        Field comparableTimSortField = Sort.class.getDeclaredField("comparableTimSort");
        comparableTimSortField.setAccessible(true);
    ...
    @Test
    public void testSortArrayWithRangeWithNullComparableTimSort ()
        throws Exception {
        Field comparableTimSortField = Sort.class.getDeclaredField("comparableTimSort");
        comparableTimSortField.setAccessible(true);
        comparableTimSortField.set(sortInstance, null);
    ...
    @Test
    public void testSortArrayWithComparatorAndRangeWithNullTimSort ()
        throws Exception {
        Field timSortField = Sort.class.getDeclaredField("timSort");
        timSortField.setAccessible(true);
        timSortField.set(sortInstance, null);
