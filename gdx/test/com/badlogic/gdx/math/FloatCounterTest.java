...
public class FloatCounterTest {
	...
	public void testLimitCases () {
		...
		counter2.put(-Float.MAX_VALUE);
		/*
		 * Because we put the max value and the total cannot be more than max value (except infinity), the new total will be 0
		 * (should we prohibit MAX_VALUE and INFINITY to avoid that?)
		 */
		...
		/*
		 * Should there be modifications to the FloatCounter class, I will be changing these last tests to try and catch clauses
		 * with the different errors that could be thrown
		 */
	}
}
