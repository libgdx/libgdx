...
final class AngleMusic implements Music, Runnable {
	...
	public AngleMusic (FileHandle handle) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
		this.handle = handle;
