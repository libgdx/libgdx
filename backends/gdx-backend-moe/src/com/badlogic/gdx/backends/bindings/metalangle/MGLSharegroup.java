...
@ObjCClassBinding
public class MGLSharegroup extends NSObject {
    static {
        NatJ.register();
    }

    @Generated
    protected MGLSharegroup(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MGLSharegroup alloc();
    ...
    @Generated
    @Selector("init")
    public native MGLSharegroup init();
