...
@ObjCClassBinding
public class MGLKView extends UIView {
    static {
        NatJ.register();
    }

    @Generated
    protected MGLKView(Pointer peer) {
        super(peer);
    }
    ...
    @Owned
    @Selector("alloc")
    public static native MGLKView alloc();
    ...
    @Generated
    @Selector("context")
    public native MGLContext context();
    ...
    @Selector("delegate")
    @MappedReturn(ObjCObjectMapper.class)
    public native MGLKViewDelegate delegate();
    ...
    @Generated
    @Selector("glLayer")
    public native MGLLayer glLayer();
    ...
    @Generated
    @Selector("init")
    public native MGLKView init();

    @Generated
    @Selector("initWithCoder:")
    public native MGLKView initWithCoder(NSCoder coder);

    @Generated
    @Selector("initWithFrame:")
    public native MGLKView initWithFrame(@ByValue CGRect frame);

    @Generated
    @Selector("initWithFrame:context:")
    public native MGLKView initWithFrameContext(@ByValue CGRect frame, MGLContext context);
    ...
    @Generated
    @Selector("setContext:")
    public native void setContext(MGLContext value);

    @Generated
    @Selector("setDelegate:")
    public native void setDelegate_unsafe(@Mapped(ObjCObjectMapper.class) MGLKViewDelegate value);

    @Generated
    public void setDelegate(@Mapped(ObjCObjectMapper.class) MGLKViewDelegate value) {
