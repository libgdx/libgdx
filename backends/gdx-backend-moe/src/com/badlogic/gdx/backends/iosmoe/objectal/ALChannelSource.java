...
public class ALChannelSource extends NSObject implements ALSoundSource {
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native ALSoundSource removeSource (@Mapped(ObjCObjectMapper.class) ALSoundSource source);
	...
	public native void setDefaultsFromSource (@Mapped(ObjCObjectMapper.class) ALSoundSource source);
