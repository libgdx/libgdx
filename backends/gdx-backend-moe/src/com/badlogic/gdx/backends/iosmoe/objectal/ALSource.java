...
@ObjCClassBinding
public class ALSource extends NSObject implements ALSoundSource, OALSuspendManager {
	static {
		NatJ.register();
	}
	...
	public native void pitchToDurationTargetSelector (float pitch, float duration, @Mapped(ObjCObjectMapper.class) Object target,
		SEL selector);
	...
	@MappedReturn(ObjCObjectMapper.class)
	public native ALSoundSource playGainPitchPanLoop (ALBuffer buffer, float gain, float pitch, float pan, boolean loop);
	...
	public native boolean queueBufferRepeats (ALBuffer buffer, @NUInt long repeats);
	...
	public native boolean queueBuffersRepeats (NSArray<?> buffers, @NUInt long repeats);
	...
	public native void registerNotificationCallbackUserData (int notificationID,
