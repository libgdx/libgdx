...
public class OALAudioSession extends NSObject implements AVAudioSessionDelegate, OALSuspendManager {
	...
	public native void setAudioSessionDelegate_unsafe (@Mapped(ObjCObjectMapper.class) AVAudioSessionDelegate value);

	@Generated
	public void setAudioSessionDelegate (@Mapped(ObjCObjectMapper.class) AVAudioSessionDelegate value) {
