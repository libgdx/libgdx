...
/**
 * {@link AudioRecorder} implementation for the applets using the java sound API.
 * 
 * @author badlogicgames@gmail.com
 * 
 */
public class AppletAudioRecorder implements AudioRecorder {
	...
	public AppletAudioRecorder (int samplingRate, boolean isMono) {
		try {
