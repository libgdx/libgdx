 ...
 * apropriate parameters and then register {@link ApplicationListener}, {@link RenderListener} or {@link InputListener} instances.
 * 
 * @author mzechner
 * 
 */
public class AppletApplication implements Application {
	...
	/**
	 * Initializes a new {@link AppletApplication}. If useGL20IfAvailable is set the AppletApplication will try to create an OpenGL
	 * 2.0 context which can then be used via {@link AppletApplication.getGraphics().getGL20()}. The {@link GL10} and {@link GL11}
	 * interfaces should not be used when OpenGL 2.0 is enabled. To query whether enabling OpenGL 2.0 was successful use the
	 * {@link AppletApplication.getGraphics().isGL20Available()} method.
	 * 
