...
public class Lwjgl3AWTInput extends AbstractInput implements MouseMotionListener, MouseListener, MouseWheelListener, KeyListener {
	class KeyEvent {
	...
	private final Lwjgl3AWTCanvas lwjglAwtCanvas;
	...
	public Lwjgl3AWTInput (Lwjgl3AWTCanvas lwjglAwtCanvas) {
