...
public class AndroidApplicationConfiguration {
	...
	/** whether to use {@link GLSurfaceView20API18} in place of the classic {@link GLSurfaceView20} on Android API 10 and lower.
	 * In case this is true {@link GLSurfaceView20API18} will be used. This implementation properly supports attach to and detach
