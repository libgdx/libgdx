...
public class GLSurfaceViewCupcake extends SurfaceView implements SurfaceHolder.Callback {
    private final static String TAG = "GLSurfaceViewCupcake";
...
//    }
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<GLSurfaceViewCupcake> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            GLSurfaceViewCupcake view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<GLSurfaceViewCupcake> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLSurfaceViewCupcake> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
...
//                        ConfigurationInfo.GL_ES_VERSION_UNDEFINED);
    ...
    private final WeakReference<GLSurfaceViewCupcake> mThisWeakRef =
            new WeakReference<GLSurfaceViewCupcake>(this);
