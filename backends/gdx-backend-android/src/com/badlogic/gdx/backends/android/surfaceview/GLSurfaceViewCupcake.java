...
public class GLSurfaceViewCupcake extends SurfaceView implements SurfaceHolder.Callback {
	 ...
	 * {@link GLSurfaceViewCupcake#setEGLConfigChooser(EGLConfigChooser)}
	 */
	public interface EGLConfigChooser {
		/**
		 * Choose a configuration from the list. Implementors typically implement this method by calling
		 * {@link EGL10#eglChooseConfig} and iterating through the results. Please consult the EGL specification available from The
		 * Khronos Group to learn how to call eglChooseConfig.
