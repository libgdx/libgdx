 ...
 * @author noblemaster
 */
public class JoglSocket  implements Socket {
	
	/** Our socket or null for disposed, aka closed. */
	private java.net.Socket socket;

	public JoglSocket(Protocol protocol, String host, int port, SocketHints hints) {
		try {
			// create the socket
	...
	public JoglSocket(java.net.Socket socket, SocketHints hints) {
		this.socket = socket;
		applyHints(hints);
	}
