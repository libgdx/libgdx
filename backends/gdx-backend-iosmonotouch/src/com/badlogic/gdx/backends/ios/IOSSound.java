...
////		}
//		
//		playerIndex = (playerIndex == MAX_PLAYERS - 1) ? 0 : playerIndex+1;
//		return playerIndex;
//		
//		// all are busy playing... :/
////		Gdx.app.debug("IOSSound", "findAvailablePlayer: all players busy");
////		return -1;
//	}
//	
//	@Override
...
//		int playerId = findAvailablePlayer();
//		if (playerId >= 0) {
//			AVAudioPlayer player = players[playerId];
