...
public abstract class GwtApplication implements EntryPoint, Application {
    ...
    public void onModuleLoad() {
        ...
        if (this.config.disableAudio) {
            ...
            SoundManager.init(GWT.getModuleBaseURL(), 9, config.preferFlash, getSoundManagerCallback());
        }
    }

    public SoundManager.SoundManagerCallback getSoundManagerCallback() {
        return new SoundManager.SoundManagerCallback() {
            @Override
            public void oncreate() {
                // here SoundManager2 is created but not yet initialized
                // so we can preconfigure it by accessing $wnd.soundManager from native methods
                // for example $wnd.soundManager.audioFormats.mp3.required = false;
            }
    ...
    public Panel createRootPanel() {
        if (config.rootPanel != null) {
            return config.rootPanel;
        } else {
    ...
    public void startPreloader() {
        ...
        preloader.preload(getAssetsFileName(), new PreloaderCallback() {
            @Override
    ...
    void setupLoop() {
        ...
        Gdx.app = this;
        Gdx.audio = config.disableAudio ? new GwtMockAudio() : new GwtAudio();
