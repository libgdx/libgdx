...
/** @author Simon Gerst */
public class GwtGL30 extends GwtGL20 implements com.badlogic.gdx.graphics.GL30 {
...
// gl.texImage3D(target, level, internalformat, width, height, depth, border, format, type, (ByteBuffer)pixels);
// else
...
// gl.texImage3D(target, level, internalformat, width, height, depth, border, format, type, offset);
	...
	public void glTexSubImage3D (int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth,
		...
		throw new UnsupportedOperationException();
// if (pixels instanceof ByteBuffer)
// gl.texSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, (ByteBuffer)pixels);
// else
// throw new GdxRuntimeException("pixels must be byte buffer");
	}
