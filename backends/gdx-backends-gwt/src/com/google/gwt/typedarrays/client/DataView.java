...
/** An ArrayBuffer is a useful object for representing an arbitrary chunk of data. In many cases, such data will be read from disk
 * or from the network, and will not follow the alignment restrictions that are imposed on the typed array views described
 * earlier. In addition, the data will often be heterogeneous in nature and have a defined byte order. The DataView view provides
 * a low-level interface for reading such data from and writing it to an ArrayBuffer.
 * 
...
public class DataView extends ArrayBufferView {
	...
	/** Gets the value of the given type at the specified byte offset from the start of the view. There is no alignment constraint;
	 * multi-byte values may be fetched from any offset.
	 * 
	 * For multi-byte values, the optional littleEndian argument indicates whether a big-endian or little-endian value should be
	 * read. If false or undefined, a big-endian value is read.
	 * 
	 * These methods raise an INDEX_SIZE_ERR exception if they would read beyond the end of the view. */
	...
	public final native void setDouble (int byteOffset, double value, boolean littleEndian) /*-{
																															this.setDouble(byteOffset, value, littleEndian);
																															}-*/;

	/** @see #setInt8(int, byte, boolean) */
	public final native void setFloat (int byteOffset, float value, boolean littleEndian) /*-{
	...
	/** Stores a value of the given type at the specified byte offset from the start of the view. There is no alignment constraint;
	 * multi-byte values may be stored at any offset.
	 * 
	 * For multi-byte values, the littleEndian argument indicates whether the value should be stored in big-endian or little-endian
	 * byte order. If false or undefined, the value is stored in big-endian byte order.
	 * 
	 * These methods throw exceptions if they would write beyond the end of the view. */
	public final native void setInt8 (int byteOffset, byte value, boolean littleEndian) /*-{
	...
	/** @see #setInt8(int, byte, boolean) */
	public final native void setUint8 (int byteOffset, byte value, boolean littleEndian) /*-{
