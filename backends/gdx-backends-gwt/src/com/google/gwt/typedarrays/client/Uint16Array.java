...
public class Uint16Array extends ArrayBufferView {
	...
	/** @see #create(ArrayBuffer, int, int) */
	public static final native Uint16Array create (ArrayBuffer buffer, int byteOffset) /*-{
	...
	public static final native Uint16Array create (ArrayBuffer buffer, int byteOffset, int length) /*-{
