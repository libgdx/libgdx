...
public class GameObject {
	...
	/**
	 * Returns true if this game object is in collision with a rectangle. It first does a simple box test against this
	 * game object's bounds, then, if that's true, tests its collision geometry against the rectangle.
	 * 
	 * @param r the rectangle to intersect.
	...
	/**
	 * Returns true if this game object is in collision with another game object. It first does a bounds test, then,
	 * if that's true, tests its collision geometry against the other game object's collision geometry.
	 */
