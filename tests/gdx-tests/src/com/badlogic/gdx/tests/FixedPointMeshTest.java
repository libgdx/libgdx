...
public class FixedPointMeshTest implements RenderListener {
	...
	/**
	 * Called when the OpenGL surface is created. We setup our MeshRenderer and Texture here.
	 */
	@Override public void surfaceCreated () {
		...
		//
		mesh = new Mesh(true, true, 3, 3, new VertexAttribute(Usage.Position, 3, "a_position"), new VertexAttribute(Usage.Color, 4,
		...
		//
		mesh
			.setVertices(new int[] {fp(-0.5f), fp(-0.5f), fp(0), fp(1), fp(0), fp(0), fp(1), fp(0), fp(0), fp(0.5f), fp(-0.5f),
				fp(0), fp(0), fp(1), fp(0), fp(1), fp(1), fp(0), fp(0.0f), fp(0.5f), fp(0), fp(0), fp(0), fp(1), fp(1), fp(0.5f),
				fp(1)});
		//
		...
		//
		texture = Gdx.graphics.newUnmanagedTexture(pixmap, TextureFilter.MipMap, TextureFilter.Linear, TextureWrap.ClampToEdge,
