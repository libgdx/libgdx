...
public class ActionArrayTest extends GdxTest implements Runnable {
	Stage stage;
	Texture texture;
	...
	public void create () {
		...
		actions.add(forever(sequence(delay(1.0f), new Action() {
		...
		for (int i = 0; i < actions.size; i++) {
			actions2[i] = actions.get(i);
		}

		// Works
		// img.addActions(actions);
		//Works
		img.addActions(actions2);
