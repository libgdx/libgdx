...
public class SortedSpriteTest extends GdxTest {
	/** 
	 * Sprite based class that adds a z-coordinate for
	 * depth sorting. Note that allt he constructors
	 * were auto-generated in Eclipse (alt + shift + s, c).
	 * @author mzechner
	 *
	 */
	public class MySprite extends Sprite {
		...
		public MySprite(Texture texture, int srcX, int srcY, int srcWidth,
				int srcHeight) {
		...
		public MySprite(TextureRegion region, int srcX, int srcY, int srcWidth,
				int srcHeight) {
