...
import com.badlogic.gdx.graphics.g3d.particles.influencers.CircularMotion;
...
/** @author ryanastout */
public class CircularMotionTest extends BaseG3dTest {
	...
	private ParticleController createBillboardController (Texture particleTexture) {
		...
		emitter.getEmission().setHigh(30);
		...
		cm.thetaValue.setActive(true);
		cm.thetaValue.setTimeline(new float[] {0});
		cm.thetaValue.setScaling(new float[] {1});
		cm.thetaValue.setHigh(45);
		cm.phiValue.setActive(true);
		cm.phiValue.setTimeline(new float[] {0});
		cm.phiValue.setScaling(new float[] {1});
		cm.phiValue.setHigh(0);
		cm.strengthValue.setActive(true);
		cm.strengthValue.setHigh(25);
		cm.strengthValue.setTimeline(new float[] {0});
		cm.strengthValue.setScaling(new float[] {1});
		cm.isGlobal = false;

		dynamicsInfluencer.velocities.add(cm);
