...
//		manager.load("data/multipagefont_cpy.fnt", BitmapFont.class);
...
//		manager.unload("data/multipagefont_cpy.fnt");
...
// manager.unload("data/tiledmap/tilemap csv.tmx");
	...
	public void render () {
		...
		if (manager.isLoaded("data/multipagefont_cpy.fnt")) 
			manager.get("data/multipagefont_cpy.fnt", BitmapFont.class).draw(batch, "test This is a test qpRPN multi page!", 100, 400);
		
//		System.out.println(Arrays.toString(manager.getAssetNames().items));
		
//		if (manager.isLoaded("data/multipagefont.fnt") && manager.isLoaded("data/multipagefont_cpy.fnt")) {
//			System.out.println(manager.get("data/multipagefont.fnt", BitmapFont.class).getRegions()[0].getTexture()
//									== manager.get("data/multipagefont_cpy.fnt", BitmapFont.class).getRegions()[0].getTexture());
//		}
