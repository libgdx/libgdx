...
public class ConstraintsTest extends BaseBulletTest {
	...
	public void create () {
		...
		final Mesh barMesh = new Mesh(true, 8, 36, new VertexAttribute(Usage.Position, 3, "a_position"), new VertexAttribute(
			Usage.ColorPacked, 4, "a_color"));
		barMesh.setVertices(new float[] {5f, 0.5f, 0.5f, Color.toFloatBits(0, 255, 0, 255), 5f, 0.5f, -0.5f,
			Color.toFloatBits(0, 255, 0, 255), -5f, 0.5f, 0.5f, Color.toFloatBits(0, 255, 0, 255), -5f, 0.5f, -0.5f,
			Color.toFloatBits(0, 255, 0, 255), 5f, -0.5f, 0.5f, Color.toFloatBits(0, 255, 0, 255), 5f, -0.5f, -0.5f,
			Color.toFloatBits(0, 255, 0, 255), -5f, -0.5f, 0.5f, Color.toFloatBits(0, 255, 0, 255), -5f, -0.5f, -0.5f,
