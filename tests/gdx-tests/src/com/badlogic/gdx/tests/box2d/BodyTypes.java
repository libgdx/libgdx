...
public class BodyTypes extends Box2DTest {
	...
	@Override public boolean keyDown (int keyCode) {
		if (keyCode == Keys.KEYCODE_D) m_platform.setType(BodyType.DynamicBody);
		if (keyCode == Keys.KEYCODE_S) m_platform.setType(BodyType.StaticBody);
		if (keyCode == Keys.KEYCODE_K) {
