...
/** Same test as {@link AnimationTest} other than the fact that this one uses the animation copy constructor
 * @author Daniel Christopher */
public class AnimationTest2 extends GdxTest {
	...
	public void create () {
		...
		rightWalk = new Animation(leftWalk);

		rightWalk.flipKeyFrames(true, false);
