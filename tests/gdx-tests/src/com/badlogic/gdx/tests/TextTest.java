...
public class TextTest implements RenderListener {
	...
	@Override public void render () {
		...
		spriteBatch.begin();
		spriteBatch.draw(font.getTexture(), 0, 100, font.getTexture().getWidth(), font.getTexture().getHeight(), 0, 0, font
			.getTexture().getWidth(), font.getTexture().getHeight(), Color.WHITE, false, true);
