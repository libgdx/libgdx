...
import com.badlogic.gdx.tests.net.DatagramClientExample;
import com.badlogic.gdx.tests.net.DatagramServerExample;
...
public class GdxTests {
	public static final List<Class<? extends GdxTest>> tests = new ArrayList<Class<? extends GdxTest>>(Arrays.asList(
                ...
                WaterRipples.class,
                YDownTest.class,
                DatagramClientExample.class,
                DatagramServerExample.class
                // @on
