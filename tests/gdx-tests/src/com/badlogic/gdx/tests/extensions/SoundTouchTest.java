...
/** Demonstrates how to read an OGG file and play it back with a {@link VorbisDecoder} as well as how to alter the audio pitch with
 * the {@link SoundTouch} API exposed in the gdx-audio extension.
 * @author mzechner */
public class SoundTouchTest extends GdxTest {
	...
	public void create () {
		...
		Gdx.app.log("SoundTouchTest", "channels: " + decoder.getChannels() + ", rate: " + decoder.getRate() + ", length: "
			+ decoder.getLength());
