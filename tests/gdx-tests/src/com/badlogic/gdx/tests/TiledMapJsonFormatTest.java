...
public class TiledMapJsonFormatTest extends GdxTest {
	private final static String MAP_ORTHO = "data/maps/tiled-json/ortho.tmj";
	private final static String MAP_ISO = "data/maps/tiled-json/iso.tmj";
	private final static String MAP_ISO_STAG = "data/maps/tiled-json/iso_stag.tmj";
	private final static String MAP_HEX_X = "data/maps/tiled-json/hex_x.tmj";
	private final static String MAP_HEX_Y = "data/maps/tiled-json/hex_y.tmj";
	private final static String MAP_ORTHO2 = "data/maps/tiled-json/ortho2.tmj";
	...
	public void create () {
		...
		assetManager.load(MAP_ORTHO2, TiledMap.class);
