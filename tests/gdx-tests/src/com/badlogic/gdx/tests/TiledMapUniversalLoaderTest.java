...
public class TiledMapUniversalLoaderTest extends GdxTest {
	 ...
	 public void create () {
		  ...
		  /**
			* This test is just to show off that passing in parameters build from the BaseTiledMapLoader.Parameters
			* would work. Note that you can not pass in Parameters of a different subclass map loader type.
			* e.g. No TmxMapLoader.Parameters into a .tmj map. */
