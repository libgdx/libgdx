...
<a name="triage"></a>
## Triaging issues and bugs [![Open Source Helpers](https://www.codetriage.com/libgdx/libgdx/badges/users.svg)](https://www.codetriage.com/libgdx/libgdx)

You can triage issues which may include reproducing bug reports or asking for vital information, such as version numbers or reproduction instructions. If you would like to start triaging issues, one easy way to get started is to [subscribe to libgdx on CodeTriage](https://www.codetriage.com/libgdx/libgdx).
