...
@XmlType(name = "", propOrder = {"positionOrNormal", "poseref"})
...
public class Keyframe {
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Position } {@link Normal } */
	 ...
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot. Therefore any modification you make to the
	 * returned list will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the poseref
	 * property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 ...
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link Poseref } */
