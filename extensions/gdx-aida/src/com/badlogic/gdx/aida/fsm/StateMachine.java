...
public interface StateMachine<E> {
	 ...
	 * <p>
	 * Implementation classes should invoke first the {@code execute} method
	 * of the global state (if any) then the {@code execute} method of the
	 * current state.
	 */
	public void update();
	 ...
	 * <p>
	 * Implementation classes should invoke the {@code execute} method of the global state
	 * every time the FSM is updated. Also, they should never invoke its {@code enter} and
	 * {@code exit} method.
	 */
	 ...
	 * If the current state does not deal with the message, it should be routed
	 * to the global state.
	 * @param telegram
