 ...
 * as the basis of this steering behavior, although it is sensitive to discontinuities in the field. For instance, a flow field
 * can be generated by a simple random algorithm, a Perlin noise or a complicated image processing. And of course flow fields can
 * be dynamic. The only limit is your imagination.
 * 
