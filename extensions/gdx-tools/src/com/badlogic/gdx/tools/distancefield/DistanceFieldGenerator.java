...
public class DistanceFieldGenerator {
	 ...
	 * 
	 * <p>
	 * Any color with one of its color channels at least 128 <em>and</em> its alpha channel at least 128 is considered "inside". */
	 ...
	 * <em>negative</em> distance to the closest "inside" pixel. If no pixel of different color is found within a radius of
