...
public abstract class ImagePickerPanel<T> extends EditorPanel<T> {
	JLabel imageLabel;
	JLabel widthLabel;
	JLabel heightLabel;
	String lastDir;

	public ImagePickerPanel (ParticleEditor3D editor, String name, String description) {
		...
		JPanel contentPanel = getContentPanel();
		{
			...
			openButton.addActionListener(new ActionListener() {
				public void actionPerformed (ActionEvent event) {
					...
					lastDir = dir;
					try {
						File fullPath = new File(dir, file);
						//ImageIcon icon = new ImageIcon(fullPath.toURI().toURL());
						onImageFileSelected(fullPath.getAbsolutePath());
						/*
						final ParticleController emitter = editor.getEmitter();
		...
		}
		{
			...
			defaultButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed (ActionEvent e) {
					final ParticleController emitter = editor.getEmitter();
					/*
					emitter.setImagePath(ParticleEditor3D.DEFAULT_PARTICLE);
					emitter.setRegion(null);
	...
	protected abstract void onImageFileSelected (String absolutePath);
}
