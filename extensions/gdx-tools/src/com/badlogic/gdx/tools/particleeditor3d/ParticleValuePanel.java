...
public class ParticleValuePanel<T extends ParticleValue> extends EditorPanel<T> {
	...
	public ParticleValuePanel (ParticleEditor3D editor, String name, String description, boolean isAlwaysActive) {
		this(editor, name, description, isAlwaysActive, false);
	}
	
	public ParticleValuePanel (ParticleEditor3D editor, String name, String description, boolean isAlwaysActive, boolean isRemovable) {
