...
class ScaledNumericPanel extends ParticleValuePanel<ScaledNumericValue> {
	...
	public ScaledNumericPanel (ParticleEditor3D editor, ScaledNumericValue value, String chartTitle, String name, String description){
