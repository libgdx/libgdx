...
public class ForcePanel extends EditorPanel
{
	JComboBox mTypeBox;
	...
	public ForcePanel(VelocityValue aValue, String charTitle, String name, String description) 
	{
		this(aValue, charTitle, name, description, true);
	}
	
	public ForcePanel(final VelocityValue aValue, String charTitle, String name, String description, boolean isAlwaysActive) 
	{
	...
	protected void setAnglesVisible(boolean selected)
	{
		mThetaPanel.setVisible(selected);
		mPhiPanel.setVisible(selected);
	}
	...
	private void initializeComponents(VelocityValue aValue, String charTitle) 
	{
		JPanel contentPanel = getContentPanel();
		{
			...
			contentPanel.add(label, new GridBagConstraints(0, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE,
				new Insets(0, 0, 0, 6), 0, 0));
		}
		{
			contentPanel.add(mTypeBox = new JComboBox(new DefaultComboBoxModel(VelocityType.values())), new GridBagConstraints(1, 1, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE,
