...
import com.badlogic.gdx.graphics.g3d.particles.Emitter.SpawnEllipseSide;
import com.badlogic.gdx.graphics.g3d.particles.Emitter.SpawnShape;
import com.badlogic.gdx.graphics.g3d.particles.Emitter.SpawnShapeValue;
...
class SpawnPanel extends EditorPanel {
	...
	public SpawnPanel (final ParticleEditor3D editor, final SpawnShapeValue spawnShapeValue, String name, String description) {
		...
		shapeCombo.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent event) {
				...
				case line:
					...
					editor.setVisible("Spawn Depth", true);
					break;
				case rectangle:
				...
				case point:
					...
					editor.setVisible("Spawn Depth", false);
					break;
				}
			}
		});
