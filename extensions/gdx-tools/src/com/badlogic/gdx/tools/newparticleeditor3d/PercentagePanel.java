...
class PercentagePanel extends EditorPanel<ScaledNumericValue> {
	JButton expandButton;
	Chart chart;

	public PercentagePanel (ParticleEditor3D editor, ScaledNumericValue value, String chartTitle, String name, String description) {
