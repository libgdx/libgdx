...
public enum Language {
	JAVA("java", "", "", "",
		"java-library;java-library;java-library;com.android.application;java-library,robovm;java-library,moe;java-library,gwt,war,org.gretty",
	...
	private Language (String name, String buildScript, String buildScriptDependencies, String dependencies, String src,
		...
		this.iosmoePlugins = parts[5].split(",");
		this.htmlPlugins = parts[6].split(",");
