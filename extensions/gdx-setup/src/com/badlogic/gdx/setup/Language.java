...
public enum Language {
	JAVA ("java", "", "", "", "java-library;java-library;com.android.application;java-library,robovm;java-library,moe;java-library,gwt,war,org.gretty", true) ,	KOTLIN ("kotlin", "ext.kotlinVersion = '1.3.41'",
