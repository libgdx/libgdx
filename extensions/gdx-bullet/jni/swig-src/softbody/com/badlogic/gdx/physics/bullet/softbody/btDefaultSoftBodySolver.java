...
public class btDefaultSoftBodySolver extends btSoftBodySolver {
	...
	/** Construct a new btDefaultSoftBodySolver, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void optimize (SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t softBodies, boolean forceUpdate) {
		SoftbodyJNI.btDefaultSoftBodySolver_optimize__SWIG_0(swigCPtr, this,
	...
	public void optimize (SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t softBodies) {
		SoftbodyJNI.btDefaultSoftBodySolver_optimize__SWIG_1(swigCPtr, this,
	...
	public void copySoftBodyToVertexBuffer (btSoftBody softBody, btVertexBufferDescriptor vertexBuffer) {
		SoftbodyJNI.btDefaultSoftBodySolver_copySoftBodyToVertexBuffer(swigCPtr, this, btSoftBody.getCPtr(softBody), softBody,
			btVertexBufferDescriptor.getCPtr(vertexBuffer), vertexBuffer);
	}

	public void processCollision (btSoftBody arg0, btCollisionObjectWrapper arg1) {
		SoftbodyJNI.btDefaultSoftBodySolver_processCollision__SWIG_0(swigCPtr, this, btSoftBody.getCPtr(arg0), arg0,
			btCollisionObjectWrapper.getCPtr(arg1), arg1);
	}

	public void processCollision (btSoftBody arg0, btSoftBody arg1) {
		SoftbodyJNI.btDefaultSoftBodySolver_processCollision__SWIG_1(swigCPtr, this, btSoftBody.getCPtr(arg0), arg0,
