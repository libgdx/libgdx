...
public class SoftBodyPoseData extends BulletBase {
  ...
  public void setRot(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_rot_set(swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }

  public btMatrix3x3FloatData getRot() {
    long cPtr = SoftbodyJNI.SoftBodyPoseData_rot_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btMatrix3x3FloatData(cPtr, false);
  }

  public void setScale(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_scale_set(swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }

  public btMatrix3x3FloatData getScale() {
    long cPtr = SoftbodyJNI.SoftBodyPoseData_scale_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btMatrix3x3FloatData(cPtr, false);
  }

  public void setAqq(btMatrix3x3FloatData value) {
    SoftbodyJNI.SoftBodyPoseData_aqq_set(swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }

  public btMatrix3x3FloatData getAqq() {
    long cPtr = SoftbodyJNI.SoftBodyPoseData_aqq_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btMatrix3x3FloatData(cPtr, false);
  }
