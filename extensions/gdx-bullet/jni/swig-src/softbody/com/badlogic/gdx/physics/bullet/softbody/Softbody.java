...
public class Softbody implements SoftbodyConstants {
  ...
  public static float ImplicitSolve(SWIGTYPE_p_btSoftBody__ImplicitFn fn, Vector3 a, Vector3 b, float accuracy, int maxiterations) {
    return SoftbodyJNI.ImplicitSolve__SWIG_0(SWIGTYPE_p_btSoftBody__ImplicitFn.getCPtr(fn), a, b, accuracy, maxiterations);
  }

  public static float ImplicitSolve(SWIGTYPE_p_btSoftBody__ImplicitFn fn, Vector3 a, Vector3 b, float accuracy) {
    return SoftbodyJNI.ImplicitSolve__SWIG_1(SWIGTYPE_p_btSoftBody__ImplicitFn.getCPtr(fn), a, b, accuracy);
  }
  ...
  public static btDbvtAabbMm VolumeOf(Face f, float margin) {
    return new btDbvtAabbMm(SoftbodyJNI.VolumeOf__SWIG_0(Face.getCPtr(f), f, margin), true);
  }

  public static Vector3 CenterOf(Face f) {
	return SoftbodyJNI.CenterOf(Face.getCPtr(f), f);
}
  ...
  public static void EvaluateMedium(btSoftBodyWorldInfo wfi, Vector3 x, sMedium medium) {
    SoftbodyJNI.EvaluateMedium(btSoftBodyWorldInfo.getCPtr(wfi), wfi, x, sMedium.getCPtr(medium), medium);
  }

  public static void ApplyClampedForce(Node n, Vector3 f, float dt) {
    SoftbodyJNI.ApplyClampedForce(Node.getCPtr(n), n, f, dt);
  }

  public static int MatchEdge(Node a, Node b, Node ma, Node mb) {
    return SoftbodyJNI.MatchEdge(Node.getCPtr(a), a, Node.getCPtr(b), b, Node.getCPtr(ma), ma, Node.getCPtr(mb), mb);
  }
