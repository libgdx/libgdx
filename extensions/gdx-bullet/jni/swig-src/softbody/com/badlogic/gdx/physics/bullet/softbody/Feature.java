...
public class Feature extends Element {
	...
	protected Feature(final String className, long cPtr, boolean cMemoryOwn) {
		super(className, SoftbodyJNI.Feature_SWIGUpcast(cPtr), cMemoryOwn);
		swigCPtr = cPtr;
	}
	...
	protected void reset(long cPtr, boolean cMemoryOwn) {
		if (!destroyed)
			destroy();
		super.reset(SoftbodyJNI.Feature_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
	}
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				SoftbodyJNI.delete_Feature(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setMaterial(Material value) {
    SoftbodyJNI.Feature_material_set(swigCPtr, this, Material.getCPtr(value), value);
  }

  public Material getMaterial() {
    long cPtr = SoftbodyJNI.Feature_material_get(swigCPtr, this);
    return (cPtr == 0) ? null : new Material(cPtr, false);
  }

  public Feature() {
    this(SoftbodyJNI.new_Feature(), true);
  }
