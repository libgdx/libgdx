...
public class btSoftBodyRigidBodyCollisionConfiguration extends btDefaultCollisionConfiguration {
	...
	/** Construct a new btSoftBodyRigidBodyCollisionConfiguration, normally you should not need this constructor it's intended for
	 * low-level usage. */
	...
	public btSoftBodyRigidBodyCollisionConfiguration (btDefaultCollisionConstructionInfo constructionInfo) {
		this(SoftbodyJNI.new_btSoftBodyRigidBodyCollisionConfiguration__SWIG_0(
			btDefaultCollisionConstructionInfo.getCPtr(constructionInfo), constructionInfo), true);
	}
