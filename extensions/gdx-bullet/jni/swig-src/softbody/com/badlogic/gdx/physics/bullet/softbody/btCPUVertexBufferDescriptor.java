...
public class btCPUVertexBufferDescriptor extends btVertexBufferDescriptor {
	...
	/** Construct a new btCPUVertexBufferDescriptor, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	static private long SwigConstructbtCPUVertexBufferDescriptor (java.nio.FloatBuffer basePointer, int vertexOffset,
		int vertexStride) {
	...
	static private long SwigConstructbtCPUVertexBufferDescriptor (java.nio.FloatBuffer basePointer, int vertexOffset,
		...
		assert basePointer.isDirect() : "Buffer must be allocated direct.";
		return SoftbodyJNI.new_btCPUVertexBufferDescriptor__SWIG_1(basePointer, vertexOffset, vertexStride, normalOffset,
			normalStride);
	}

	public btCPUVertexBufferDescriptor (java.nio.FloatBuffer basePointer, int vertexOffset, int vertexStride, int normalOffset,
		int normalStride) {
		this(btCPUVertexBufferDescriptor.SwigConstructbtCPUVertexBufferDescriptor(basePointer, vertexOffset, vertexStride,
			normalOffset, normalStride), true);
	}
