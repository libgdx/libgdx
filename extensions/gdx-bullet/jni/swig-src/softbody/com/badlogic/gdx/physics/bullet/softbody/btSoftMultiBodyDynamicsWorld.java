...
public class btSoftMultiBodyDynamicsWorld extends btMultiBodyDynamicsWorld {
	...
	/** Construct a new btSoftMultiBodyDynamicsWorld, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btSoftMultiBodyDynamicsWorld (btDispatcher dispatcher, btBroadphaseInterface pairCache,
		btMultiBodyConstraintSolver constraintSolver, btCollisionConfiguration collisionConfiguration,
		btSoftBodySolver softBodySolver) {
		this(SoftbodyJNI.new_btSoftMultiBodyDynamicsWorld__SWIG_0(btDispatcher.getCPtr(dispatcher), dispatcher,
			btBroadphaseInterface.getCPtr(pairCache), pairCache, btMultiBodyConstraintSolver.getCPtr(constraintSolver),
			constraintSolver, btCollisionConfiguration.getCPtr(collisionConfiguration), collisionConfiguration,
			btSoftBodySolver.getCPtr(softBodySolver), softBodySolver), true);
	}

	public btSoftMultiBodyDynamicsWorld (btDispatcher dispatcher, btBroadphaseInterface pairCache,
		btMultiBodyConstraintSolver constraintSolver, btCollisionConfiguration collisionConfiguration) {
		this(SoftbodyJNI.new_btSoftMultiBodyDynamicsWorld__SWIG_1(btDispatcher.getCPtr(dispatcher), dispatcher,
			btBroadphaseInterface.getCPtr(pairCache), pairCache, btMultiBodyConstraintSolver.getCPtr(constraintSolver),
			constraintSolver, btCollisionConfiguration.getCPtr(collisionConfiguration), collisionConfiguration), true);
	}

	public void addSoftBody (btSoftBody body, int collisionFilterGroup, int collisionFilterMask) {
		SoftbodyJNI.btSoftMultiBodyDynamicsWorld_addSoftBody__SWIG_0(swigCPtr, this, btSoftBody.getCPtr(body), body,
			collisionFilterGroup, collisionFilterMask);
	}

	public void addSoftBody (btSoftBody body, int collisionFilterGroup) {
		SoftbodyJNI.btSoftMultiBodyDynamicsWorld_addSoftBody__SWIG_1(swigCPtr, this, btSoftBody.getCPtr(body), body,
	...
	public SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t getSoftBodyArray () {
		return new SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t(
			SoftbodyJNI.btSoftMultiBodyDynamicsWorld_getSoftBodyArray(swigCPtr, this), false);
	}

	public SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t getSoftBodyArrayConst () {
		return new SWIGTYPE_p_btAlignedObjectArrayT_btSoftBody_p_t(
			SoftbodyJNI.btSoftMultiBodyDynamicsWorld_getSoftBodyArrayConst(swigCPtr, this), false);
	}
	...
	public static void rayTestSingle (Matrix4 rayFromTrans, Matrix4 rayToTrans, btCollisionObject collisionObject,
		...
		SoftbodyJNI.btSoftMultiBodyDynamicsWorld_rayTestSingle(rayFromTrans, rayToTrans, btCollisionObject.getCPtr(collisionObject),
