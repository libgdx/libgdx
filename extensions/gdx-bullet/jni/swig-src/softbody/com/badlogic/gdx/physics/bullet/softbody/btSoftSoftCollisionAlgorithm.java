...
public class btSoftSoftCollisionAlgorithm extends btCollisionAlgorithm {
	...
	/** Construct a new btSoftSoftCollisionAlgorithm, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btSoftSoftCollisionAlgorithm (btPersistentManifold mf, btCollisionAlgorithmConstructionInfo ci,
		btCollisionObjectWrapper body0Wrap, btCollisionObjectWrapper body1Wrap) {
		this(SoftbodyJNI.new_btSoftSoftCollisionAlgorithm__SWIG_1(btPersistentManifold.getCPtr(mf), mf,
