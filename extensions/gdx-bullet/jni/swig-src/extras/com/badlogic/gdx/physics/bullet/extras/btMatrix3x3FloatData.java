...
public class btMatrix3x3FloatData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btMatrix3x3FloatData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setEl(btVector3FloatData value) {
    ExtrasJNI.btMatrix3x3FloatData_el_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getEl() {
    long cPtr = ExtrasJNI.btMatrix3x3FloatData_el_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public btMatrix3x3FloatData() {
    this(ExtrasJNI.new_btMatrix3x3FloatData(), true);
  }
