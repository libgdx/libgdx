...
public class btMatrix3x3DoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btMatrix3x3DoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setEl(btVector3DoubleData value) {
    ExtrasJNI.btMatrix3x3DoubleData_el_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getEl() {
    long cPtr = ExtrasJNI.btMatrix3x3DoubleData_el_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public btMatrix3x3DoubleData() {
    this(ExtrasJNI.new_btMatrix3x3DoubleData(), true);
  }
