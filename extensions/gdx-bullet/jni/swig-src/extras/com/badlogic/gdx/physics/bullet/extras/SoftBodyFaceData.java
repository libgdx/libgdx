...
public class SoftBodyFaceData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_SoftBodyFaceData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setNormal(btVector3FloatData value) {
    ExtrasJNI.SoftBodyFaceData_normal_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getNormal() {
    long cPtr = ExtrasJNI.SoftBodyFaceData_normal_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setMaterial(SoftBodyMaterialData value) {
    ExtrasJNI.SoftBodyFaceData_material_set(swigCPtr, this, SoftBodyMaterialData.getCPtr(value), value);
  }

  public SoftBodyMaterialData getMaterial() {
    long cPtr = ExtrasJNI.SoftBodyFaceData_material_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SoftBodyMaterialData(cPtr, false);
  }

  public void setNodeIndices(int[] value) {
    ExtrasJNI.SoftBodyFaceData_nodeIndices_set(swigCPtr, this, value);
  }

  public int[] getNodeIndices() {
    return ExtrasJNI.SoftBodyFaceData_nodeIndices_get(swigCPtr, this);
}

  public void setRestArea(float value) {
    ExtrasJNI.SoftBodyFaceData_restArea_set(swigCPtr, this, value);
  }

  public float getRestArea() {
    return ExtrasJNI.SoftBodyFaceData_restArea_get(swigCPtr, this);
  }

  public SoftBodyFaceData() {
    this(ExtrasJNI.new_SoftBodyFaceData(), true);
  }
