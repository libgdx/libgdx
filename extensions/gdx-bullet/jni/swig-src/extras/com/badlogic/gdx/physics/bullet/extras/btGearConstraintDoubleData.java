...
public class btGearConstraintDoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btGearConstraintDoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setTypeConstraintData(btTypedConstraintDoubleData value) {
    ExtrasJNI.btGearConstraintDoubleData_typeConstraintData_set(swigCPtr, this, btTypedConstraintDoubleData.getCPtr(value), value);
  }

  public btTypedConstraintDoubleData getTypeConstraintData() {
    long cPtr = ExtrasJNI.btGearConstraintDoubleData_typeConstraintData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btTypedConstraintDoubleData(cPtr, false);
  }

  public void setAxisInA(btVector3DoubleData value) {
    ExtrasJNI.btGearConstraintDoubleData_axisInA_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getAxisInA() {
    long cPtr = ExtrasJNI.btGearConstraintDoubleData_axisInA_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setAxisInB(btVector3DoubleData value) {
    ExtrasJNI.btGearConstraintDoubleData_axisInB_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getAxisInB() {
    long cPtr = ExtrasJNI.btGearConstraintDoubleData_axisInB_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setRatio(double value) {
    ExtrasJNI.btGearConstraintDoubleData_ratio_set(swigCPtr, this, value);
  }

  public double getRatio() {
    return ExtrasJNI.btGearConstraintDoubleData_ratio_get(swigCPtr, this);
  }

  public btGearConstraintDoubleData() {
    this(ExtrasJNI.new_btGearConstraintDoubleData(), true);
  }
