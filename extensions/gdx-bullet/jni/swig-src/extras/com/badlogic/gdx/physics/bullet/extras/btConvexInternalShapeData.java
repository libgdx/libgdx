...
public class btConvexInternalShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btConvexInternalShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setCollisionShapeData(btCollisionShapeData value) {
    ExtrasJNI.btConvexInternalShapeData_collisionShapeData_set(swigCPtr, this, btCollisionShapeData.getCPtr(value), value);
  }

  public btCollisionShapeData getCollisionShapeData() {
    long cPtr = ExtrasJNI.btConvexInternalShapeData_collisionShapeData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btCollisionShapeData(cPtr, false);
  }

  public void setLocalScaling(btVector3FloatData value) {
    ExtrasJNI.btConvexInternalShapeData_localScaling_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getLocalScaling() {
    long cPtr = ExtrasJNI.btConvexInternalShapeData_localScaling_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setImplicitShapeDimensions(btVector3FloatData value) {
    ExtrasJNI.btConvexInternalShapeData_implicitShapeDimensions_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getImplicitShapeDimensions() {
    long cPtr = ExtrasJNI.btConvexInternalShapeData_implicitShapeDimensions_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setCollisionMargin(float value) {
    ExtrasJNI.btConvexInternalShapeData_collisionMargin_set(swigCPtr, this, value);
  }

  public float getCollisionMargin() {
    return ExtrasJNI.btConvexInternalShapeData_collisionMargin_get(swigCPtr, this);
  }

  public void setPadding(int value) {
    ExtrasJNI.btConvexInternalShapeData_padding_set(swigCPtr, this, value);
  }

  public int getPadding() {
    return ExtrasJNI.btConvexInternalShapeData_padding_get(swigCPtr, this);
  }

  public btConvexInternalShapeData() {
    this(ExtrasJNI.new_btConvexInternalShapeData(), true);
  }
