...
public class btQuaternionDoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btQuaternionDoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setFloats(double[] value) {
    ExtrasJNI.btQuaternionDoubleData_floats_set(swigCPtr, this, value);
  }

  public double[] getFloats() {
    return ExtrasJNI.btQuaternionDoubleData_floats_get(swigCPtr, this);
}

  public btQuaternionDoubleData() {
    this(ExtrasJNI.new_btQuaternionDoubleData(), true);
  }
