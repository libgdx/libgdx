...
public class btCapsuleShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btCapsuleShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    ExtrasJNI.btCapsuleShapeData_convexInternalShapeData_set(swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }

  public btConvexInternalShapeData getConvexInternalShapeData() {
    long cPtr = ExtrasJNI.btCapsuleShapeData_convexInternalShapeData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btConvexInternalShapeData(cPtr, false);
  }

  public void setUpAxis(int value) {
    ExtrasJNI.btCapsuleShapeData_upAxis_set(swigCPtr, this, value);
  }

  public int getUpAxis() {
    return ExtrasJNI.btCapsuleShapeData_upAxis_get(swigCPtr, this);
  }

  public void setPadding(String value) {
    ExtrasJNI.btCapsuleShapeData_padding_set(swigCPtr, this, value);
  }

  public String getPadding() {
    return ExtrasJNI.btCapsuleShapeData_padding_get(swigCPtr, this);
  }

  public btCapsuleShapeData() {
    this(ExtrasJNI.new_btCapsuleShapeData(), true);
  }
