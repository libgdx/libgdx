...
public class btMultiSphereShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btMultiSphereShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    ExtrasJNI.btMultiSphereShapeData_convexInternalShapeData_set(swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }

  public btConvexInternalShapeData getConvexInternalShapeData() {
    long cPtr = ExtrasJNI.btMultiSphereShapeData_convexInternalShapeData_get(swigCPtr, this);
  ...
  public void setLocalPositionArrayPtr(btPositionAndRadius value) {
    ExtrasJNI.btMultiSphereShapeData_localPositionArrayPtr_set(swigCPtr, this, btPositionAndRadius.getCPtr(value), value);
  }

  public btPositionAndRadius getLocalPositionArrayPtr() {
    long cPtr = ExtrasJNI.btMultiSphereShapeData_localPositionArrayPtr_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btPositionAndRadius(cPtr, false);
  }

  public void setLocalPositionArraySize(int value) {
    ExtrasJNI.btMultiSphereShapeData_localPositionArraySize_set(swigCPtr, this, value);
  }

  public int getLocalPositionArraySize() {
    return ExtrasJNI.btMultiSphereShapeData_localPositionArraySize_get(swigCPtr, this);
  }

  public void setPadding(String value) {
    ExtrasJNI.btMultiSphereShapeData_padding_set(swigCPtr, this, value);
  }

  public String getPadding() {
    return ExtrasJNI.btMultiSphereShapeData_padding_get(swigCPtr, this);
  }

  public btMultiSphereShapeData() {
    this(ExtrasJNI.new_btMultiSphereShapeData(), true);
  }
