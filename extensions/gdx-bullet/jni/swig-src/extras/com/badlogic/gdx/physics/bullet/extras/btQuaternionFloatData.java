...
public class btQuaternionFloatData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btQuaternionFloatData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setFloats(float[] value) {
    ExtrasJNI.btQuaternionFloatData_floats_set(swigCPtr, this, value);
  }

  public float[] getFloats() {
    return ExtrasJNI.btQuaternionFloatData_floats_get(swigCPtr, this);
}

  public btQuaternionFloatData() {
    this(ExtrasJNI.new_btQuaternionFloatData(), true);
  }
