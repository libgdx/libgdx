...
public class btShortIntIndexData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btShortIntIndexData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setValue(short value) {
    ExtrasJNI.btShortIntIndexData_value_set(swigCPtr, this, value);
  }

  public short getValue() {
    return ExtrasJNI.btShortIntIndexData_value_get(swigCPtr, this);
  }

  public void setPad(String value) {
    ExtrasJNI.btShortIntIndexData_pad_set(swigCPtr, this, value);
  }

  public String getPad() {
    return ExtrasJNI.btShortIntIndexData_pad_get(swigCPtr, this);
  }

  public btShortIntIndexData() {
    this(ExtrasJNI.new_btShortIntIndexData(), true);
  }
