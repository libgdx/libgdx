...
public class btCylinderShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btCylinderShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    ExtrasJNI.btCylinderShapeData_convexInternalShapeData_set(swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }

  public btConvexInternalShapeData getConvexInternalShapeData() {
    long cPtr = ExtrasJNI.btCylinderShapeData_convexInternalShapeData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btConvexInternalShapeData(cPtr, false);
  }

  public void setUpAxis(int value) {
    ExtrasJNI.btCylinderShapeData_upAxis_set(swigCPtr, this, value);
  }

  public int getUpAxis() {
    return ExtrasJNI.btCylinderShapeData_upAxis_get(swigCPtr, this);
  }

  public void setPadding(String value) {
    ExtrasJNI.btCylinderShapeData_padding_set(swigCPtr, this, value);
  }

  public String getPadding() {
    return ExtrasJNI.btCylinderShapeData_padding_get(swigCPtr, this);
  }

  public btCylinderShapeData() {
    this(ExtrasJNI.new_btCylinderShapeData(), true);
  }
