...
public class btTransformFloatData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btTransformFloatData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setBasis(btMatrix3x3FloatData value) {
    ExtrasJNI.btTransformFloatData_basis_set(swigCPtr, this, btMatrix3x3FloatData.getCPtr(value), value);
  }

  public btMatrix3x3FloatData getBasis() {
    long cPtr = ExtrasJNI.btTransformFloatData_basis_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btMatrix3x3FloatData(cPtr, false);
  }

  public void setOrigin(btVector3FloatData value) {
    ExtrasJNI.btTransformFloatData_origin_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getOrigin() {
    long cPtr = ExtrasJNI.btTransformFloatData_origin_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public btTransformFloatData() {
    this(ExtrasJNI.new_btTransformFloatData(), true);
  }
