...
public class btPositionAndRadius extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btPositionAndRadius(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setPos(btVector3FloatData value) {
    ExtrasJNI.btPositionAndRadius_pos_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getPos() {
    long cPtr = ExtrasJNI.btPositionAndRadius_pos_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setRadius(float value) {
    ExtrasJNI.btPositionAndRadius_radius_set(swigCPtr, this, value);
  }

  public float getRadius() {
    return ExtrasJNI.btPositionAndRadius_radius_get(swigCPtr, this);
  }

  public btPositionAndRadius() {
    this(ExtrasJNI.new_btPositionAndRadius(), true);
  }
