...
public class btDynamicsWorldFloatData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btDynamicsWorldFloatData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setSolverInfo(btContactSolverInfoFloatData value) {
    ExtrasJNI.btDynamicsWorldFloatData_solverInfo_set(swigCPtr, this, btContactSolverInfoFloatData.getCPtr(value), value);
  }

  public btContactSolverInfoFloatData getSolverInfo() {
    long cPtr = ExtrasJNI.btDynamicsWorldFloatData_solverInfo_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btContactSolverInfoFloatData(cPtr, false);
  }

  public void setGravity(btVector3FloatData value) {
    ExtrasJNI.btDynamicsWorldFloatData_gravity_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getGravity() {
    long cPtr = ExtrasJNI.btDynamicsWorldFloatData_gravity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public btDynamicsWorldFloatData() {
    this(ExtrasJNI.new_btDynamicsWorldFloatData(), true);
  }
