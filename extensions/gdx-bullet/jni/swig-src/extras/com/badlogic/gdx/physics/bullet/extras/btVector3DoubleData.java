...
public class btVector3DoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btVector3DoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setFloats(double[] value) {
    ExtrasJNI.btVector3DoubleData_floats_set(swigCPtr, this, value);
  }

  public double[] getFloats() {
    return ExtrasJNI.btVector3DoubleData_floats_get(swigCPtr, this);
}

  public btVector3DoubleData() {
    this(ExtrasJNI.new_btVector3DoubleData(), true);
  }
