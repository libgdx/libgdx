...
public class btMeshPartData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btMeshPartData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setVertices3f(btVector3FloatData value) {
    ExtrasJNI.btMeshPartData_vertices3f_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getVertices3f() {
    long cPtr = ExtrasJNI.btMeshPartData_vertices3f_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setVertices3d(btVector3DoubleData value) {
    ExtrasJNI.btMeshPartData_vertices3d_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getVertices3d() {
    long cPtr = ExtrasJNI.btMeshPartData_vertices3d_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setIndices32(btIntIndexData value) {
    ExtrasJNI.btMeshPartData_indices32_set(swigCPtr, this, btIntIndexData.getCPtr(value), value);
  }

  public btIntIndexData getIndices32() {
    long cPtr = ExtrasJNI.btMeshPartData_indices32_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btIntIndexData(cPtr, false);
  }

  public void set3indices16(btShortIntIndexTripletData value) {
    ExtrasJNI.btMeshPartData_3indices16_set(swigCPtr, this, btShortIntIndexTripletData.getCPtr(value), value);
  }

  public btShortIntIndexTripletData get3indices16() {
    long cPtr = ExtrasJNI.btMeshPartData_3indices16_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btShortIntIndexTripletData(cPtr, false);
  }

  public void set3indices8(btCharIndexTripletData value) {
    ExtrasJNI.btMeshPartData_3indices8_set(swigCPtr, this, btCharIndexTripletData.getCPtr(value), value);
  }

  public btCharIndexTripletData get3indices8() {
    long cPtr = ExtrasJNI.btMeshPartData_3indices8_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btCharIndexTripletData(cPtr, false);
  }

  public void setIndices16(btShortIntIndexData value) {
    ExtrasJNI.btMeshPartData_indices16_set(swigCPtr, this, btShortIntIndexData.getCPtr(value), value);
  }

  public btShortIntIndexData getIndices16() {
    long cPtr = ExtrasJNI.btMeshPartData_indices16_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btShortIntIndexData(cPtr, false);
  }

  public void setNumTriangles(int value) {
    ExtrasJNI.btMeshPartData_numTriangles_set(swigCPtr, this, value);
  }

  public int getNumTriangles() {
    return ExtrasJNI.btMeshPartData_numTriangles_get(swigCPtr, this);
  }

  public void setNumVertices(int value) {
    ExtrasJNI.btMeshPartData_numVertices_set(swigCPtr, this, value);
  }

  public int getNumVertices() {
    return ExtrasJNI.btMeshPartData_numVertices_get(swigCPtr, this);
  }

  public btMeshPartData() {
    this(ExtrasJNI.new_btMeshPartData(), true);
  }
