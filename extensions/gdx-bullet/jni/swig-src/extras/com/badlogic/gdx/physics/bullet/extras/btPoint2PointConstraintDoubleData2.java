...
public class btPoint2PointConstraintDoubleData2 extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btPoint2PointConstraintDoubleData2(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setTypeConstraintData(btTypedConstraintDoubleData value) {
    ExtrasJNI.btPoint2PointConstraintDoubleData2_typeConstraintData_set(swigCPtr, this, btTypedConstraintDoubleData.getCPtr(value), value);
  }

  public btTypedConstraintDoubleData getTypeConstraintData() {
    long cPtr = ExtrasJNI.btPoint2PointConstraintDoubleData2_typeConstraintData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btTypedConstraintDoubleData(cPtr, false);
  }

  public void setPivotInA(btVector3DoubleData value) {
    ExtrasJNI.btPoint2PointConstraintDoubleData2_pivotInA_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getPivotInA() {
    long cPtr = ExtrasJNI.btPoint2PointConstraintDoubleData2_pivotInA_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setPivotInB(btVector3DoubleData value) {
    ExtrasJNI.btPoint2PointConstraintDoubleData2_pivotInB_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getPivotInB() {
    long cPtr = ExtrasJNI.btPoint2PointConstraintDoubleData2_pivotInB_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public btPoint2PointConstraintDoubleData2() {
    this(ExtrasJNI.new_btPoint2PointConstraintDoubleData2(), true);
  }
