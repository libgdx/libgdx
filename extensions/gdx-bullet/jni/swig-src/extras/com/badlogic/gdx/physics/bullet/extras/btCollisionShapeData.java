...
public class btCollisionShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btCollisionShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setName(String value) {
    ExtrasJNI.btCollisionShapeData_name_set(swigCPtr, this, value);
  }

  public String getName() {
    return ExtrasJNI.btCollisionShapeData_name_get(swigCPtr, this);
  }

  public void setShapeType(int value) {
    ExtrasJNI.btCollisionShapeData_shapeType_set(swigCPtr, this, value);
  }

  public int getShapeType() {
    return ExtrasJNI.btCollisionShapeData_shapeType_get(swigCPtr, this);
  }

  public void setPadding(String value) {
    ExtrasJNI.btCollisionShapeData_padding_set(swigCPtr, this, value);
  }

  public String getPadding() {
    return ExtrasJNI.btCollisionShapeData_padding_get(swigCPtr, this);
  }

  public btCollisionShapeData() {
    this(ExtrasJNI.new_btCollisionShapeData(), true);
  }
