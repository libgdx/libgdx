...
public class btIntIndexData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btIntIndexData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setValue(int value) {
    ExtrasJNI.btIntIndexData_value_set(swigCPtr, this, value);
  }

  public int getValue() {
    return ExtrasJNI.btIntIndexData_value_get(swigCPtr, this);
  }

  public btIntIndexData() {
    this(ExtrasJNI.new_btIntIndexData(), true);
  }
