...
public class btConeShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btConeShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    ExtrasJNI.btConeShapeData_convexInternalShapeData_set(swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }

  public btConvexInternalShapeData getConvexInternalShapeData() {
    long cPtr = ExtrasJNI.btConeShapeData_convexInternalShapeData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btConvexInternalShapeData(cPtr, false);
  }

  public void setUpIndex(int value) {
    ExtrasJNI.btConeShapeData_upIndex_set(swigCPtr, this, value);
  }

  public int getUpIndex() {
    return ExtrasJNI.btConeShapeData_upIndex_get(swigCPtr, this);
  }

  public void setPadding(String value) {
    ExtrasJNI.btConeShapeData_padding_set(swigCPtr, this, value);
  }

  public String getPadding() {
    return ExtrasJNI.btConeShapeData_padding_get(swigCPtr, this);
  }

  public btConeShapeData() {
    this(ExtrasJNI.new_btConeShapeData(), true);
  }
