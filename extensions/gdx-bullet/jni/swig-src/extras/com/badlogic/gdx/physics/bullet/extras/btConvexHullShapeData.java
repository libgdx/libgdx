...
public class btConvexHullShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btConvexHullShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setConvexInternalShapeData(btConvexInternalShapeData value) {
    ExtrasJNI.btConvexHullShapeData_convexInternalShapeData_set(swigCPtr, this, btConvexInternalShapeData.getCPtr(value), value);
  }

  public btConvexInternalShapeData getConvexInternalShapeData() {
    long cPtr = ExtrasJNI.btConvexHullShapeData_convexInternalShapeData_get(swigCPtr, this);
  ...
  public void setUnscaledPointsFloatPtr(btVector3FloatData value) {
    ExtrasJNI.btConvexHullShapeData_unscaledPointsFloatPtr_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getUnscaledPointsFloatPtr() {
    long cPtr = ExtrasJNI.btConvexHullShapeData_unscaledPointsFloatPtr_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public void setUnscaledPointsDoublePtr(btVector3DoubleData value) {
    ExtrasJNI.btConvexHullShapeData_unscaledPointsDoublePtr_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getUnscaledPointsDoublePtr() {
    long cPtr = ExtrasJNI.btConvexHullShapeData_unscaledPointsDoublePtr_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public void setNumUnscaledPoints(int value) {
    ExtrasJNI.btConvexHullShapeData_numUnscaledPoints_set(swigCPtr, this, value);
  }

  public int getNumUnscaledPoints() {
    return ExtrasJNI.btConvexHullShapeData_numUnscaledPoints_get(swigCPtr, this);
  }

  public void setPadding3(String value) {
    ExtrasJNI.btConvexHullShapeData_padding3_set(swigCPtr, this, value);
  }

  public String getPadding3() {
    return ExtrasJNI.btConvexHullShapeData_padding3_get(swigCPtr, this);
  }

  public btConvexHullShapeData() {
    this(ExtrasJNI.new_btConvexHullShapeData(), true);
  }
