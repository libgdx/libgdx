...
public class btVector3FloatData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btVector3FloatData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setFloats(float[] value) {
    ExtrasJNI.btVector3FloatData_floats_set(swigCPtr, this, value);
  }

  public float[] getFloats() {
    return ExtrasJNI.btVector3FloatData_floats_get(swigCPtr, this);
}

  public btVector3FloatData() {
    this(ExtrasJNI.new_btVector3FloatData(), true);
  }
