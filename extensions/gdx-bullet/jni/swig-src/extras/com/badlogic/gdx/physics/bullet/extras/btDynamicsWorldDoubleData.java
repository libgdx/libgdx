...
public class btDynamicsWorldDoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btDynamicsWorldDoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setSolverInfo(btContactSolverInfoDoubleData value) {
    ExtrasJNI.btDynamicsWorldDoubleData_solverInfo_set(swigCPtr, this, btContactSolverInfoDoubleData.getCPtr(value), value);
  }

  public btContactSolverInfoDoubleData getSolverInfo() {
    long cPtr = ExtrasJNI.btDynamicsWorldDoubleData_solverInfo_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btContactSolverInfoDoubleData(cPtr, false);
  }

  public void setGravity(btVector3DoubleData value) {
    ExtrasJNI.btDynamicsWorldDoubleData_gravity_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getGravity() {
    long cPtr = ExtrasJNI.btDynamicsWorldDoubleData_gravity_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public btDynamicsWorldDoubleData() {
    this(ExtrasJNI.new_btDynamicsWorldDoubleData(), true);
  }
