...
public class btTransformDoubleData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btTransformDoubleData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setBasis(btMatrix3x3DoubleData value) {
    ExtrasJNI.btTransformDoubleData_basis_set(swigCPtr, this, btMatrix3x3DoubleData.getCPtr(value), value);
  }

  public btMatrix3x3DoubleData getBasis() {
    long cPtr = ExtrasJNI.btTransformDoubleData_basis_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btMatrix3x3DoubleData(cPtr, false);
  }

  public void setOrigin(btVector3DoubleData value) {
    ExtrasJNI.btTransformDoubleData_origin_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getOrigin() {
    long cPtr = ExtrasJNI.btTransformDoubleData_origin_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3DoubleData(cPtr, false);
  }

  public btTransformDoubleData() {
    this(ExtrasJNI.new_btTransformDoubleData(), true);
  }
