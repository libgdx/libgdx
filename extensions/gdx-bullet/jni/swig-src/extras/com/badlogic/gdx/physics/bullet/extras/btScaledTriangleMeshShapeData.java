...
public class btScaledTriangleMeshShapeData extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				ExtrasJNI.delete_btScaledTriangleMeshShapeData(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setTrimeshShapeData(btTriangleMeshShapeData value) {
    ExtrasJNI.btScaledTriangleMeshShapeData_trimeshShapeData_set(swigCPtr, this, btTriangleMeshShapeData.getCPtr(value), value);
  }

  public btTriangleMeshShapeData getTrimeshShapeData() {
    long cPtr = ExtrasJNI.btScaledTriangleMeshShapeData_trimeshShapeData_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btTriangleMeshShapeData(cPtr, false);
  }

  public void setLocalScaling(btVector3FloatData value) {
    ExtrasJNI.btScaledTriangleMeshShapeData_localScaling_set(swigCPtr, this, btVector3FloatData.getCPtr(value), value);
  }

  public btVector3FloatData getLocalScaling() {
    long cPtr = ExtrasJNI.btScaledTriangleMeshShapeData_localScaling_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btVector3FloatData(cPtr, false);
  }

  public btScaledTriangleMeshShapeData() {
    this(ExtrasJNI.new_btScaledTriangleMeshShapeData(), true);
  }
