...
public class btEmptyAlgorithm extends btCollisionAlgorithm {
  ...
  static public class CreateFunc extends btCollisionAlgorithmCreateFunc {
  	...
  	protected CreateFunc(final String className, long cPtr, boolean cMemoryOwn) {
  		super(className, CollisionJNI.btEmptyAlgorithm_CreateFunc_SWIGUpcast(cPtr), cMemoryOwn);
  		swigCPtr = cPtr;
  	}
  	...
  	protected void reset(long cPtr, boolean cMemoryOwn) {
  		if (!destroyed)
  			destroy();
  		super.reset(CollisionJNI.btEmptyAlgorithm_CreateFunc_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
  	}
