...
public class Result extends BulletBase {
  ...
  @Override protected synchronized void delete() {
		if (swigCPtr != 0) {
			if (swigCMemOwn) {
				swigCMemOwn = false;
				CollisionJNI.delete_Result(swigCPtr);
			}
			swigCPtr = 0;
		}
		super.delete();
  ...
  public void setShapeIdentifiersA(int partId0, int index0) {
    CollisionJNI.Result_setShapeIdentifiersA(swigCPtr, this, partId0, index0);
  }

  public void setShapeIdentifiersB(int partId1, int index1) {
    CollisionJNI.Result_setShapeIdentifiersB(swigCPtr, this, partId1, index1);
  }

  public void addContactPoint(Vector3 normalOnBInWorld, Vector3 pointInWorld, float depth) {
    CollisionJNI.Result_addContactPoint(swigCPtr, this, normalOnBInWorld, pointInWorld, depth);
  }
