...
public class GIM_AABB extends BulletBase {
	...
	public void find_intersection (GIM_AABB other, GIM_AABB intersection) {
		CollisionJNI.GIM_AABB_find_intersection(swigCPtr, this, GIM_AABB.getCPtr(other), other, GIM_AABB.getCPtr(intersection),
			intersection);
	}
	...
	public void projection_interval (Vector3 direction, SWIGTYPE_p_float vmin, SWIGTYPE_p_float vmax) {
		CollisionJNI.GIM_AABB_projection_interval(swigCPtr, this, direction, SWIGTYPE_p_float.getCPtr(vmin),
	...
	public boolean overlapping_trans_cache (GIM_AABB box, GIM_BOX_BOX_TRANSFORM_CACHE transcache, boolean fulltest) {
		return CollisionJNI.GIM_AABB_overlapping_trans_cache(swigCPtr, this, GIM_AABB.getCPtr(box), box,
			GIM_BOX_BOX_TRANSFORM_CACHE.getCPtr(transcache), transcache, fulltest);
	}
	...
	public boolean collide_triangle_exact (Vector3 p1, Vector3 p2, Vector3 p3, btVector4 triangle_plane) {
		return CollisionJNI.GIM_AABB_collide_triangle_exact(swigCPtr, this, p1, p2, p3, btVector4.getCPtr(triangle_plane),
			triangle_plane);
	}
