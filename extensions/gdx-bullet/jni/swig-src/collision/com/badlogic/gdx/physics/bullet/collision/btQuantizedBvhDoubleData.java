...
public class btQuantizedBvhDoubleData extends BulletBase {
	...
	/** Construct a new btQuantizedBvhDoubleData, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void setContiguousNodesPtr (btOptimizedBvhNodeDoubleData value) {
		CollisionJNI.btQuantizedBvhDoubleData_contiguousNodesPtr_set(swigCPtr, this, btOptimizedBvhNodeDoubleData.getCPtr(value),
			value);
	}
	...
	public void setQuantizedContiguousNodesPtr (btQuantizedBvhNodeData value) {
		CollisionJNI.btQuantizedBvhDoubleData_quantizedContiguousNodesPtr_set(swigCPtr, this, btQuantizedBvhNodeData.getCPtr(value),
			value);
	}
