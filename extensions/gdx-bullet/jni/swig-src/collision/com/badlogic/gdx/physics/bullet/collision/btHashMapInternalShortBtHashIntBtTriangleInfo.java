...
public class btHashMapInternalShortBtHashIntBtTriangleInfo extends BulletBase {
	...
	/** Construct a new btHashMapInternalShortBtHashIntBtTriangleInfo, normally you should not need this constructor it's intended
	 * for low-level usage. */
	...
	public void insert (btHashInt key, btTriangleInfo value) {
		CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_insert(swigCPtr, this, btHashInt.getCPtr(key), key,
			btTriangleInfo.getCPtr(value), value);
	}
	...
	public btHashInt getKeyAtIndexConst (int index) {
		return new btHashInt(CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_getKeyAtIndexConst(swigCPtr, this, index),
			true);
	}

	public btTriangleInfo operatorSubscript (btHashInt key) {
		long cPtr = CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_operatorSubscript(swigCPtr, this,
			btHashInt.getCPtr(key), key);
		return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
	}

	public btTriangleInfo operatorSubscriptConst (btHashInt key) {
		long cPtr = CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_operatorSubscriptConst(swigCPtr, this,
			btHashInt.getCPtr(key), key);
		return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
	}

	public btTriangleInfo findConst (btHashInt key) {
		long cPtr = CollisionJNI.btHashMapInternalShortBtHashIntBtTriangleInfo_findConst(swigCPtr, this, btHashInt.getCPtr(key),
			key);
		return (cPtr == 0) ? null : new btTriangleInfo(cPtr, false);
	}
