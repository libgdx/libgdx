...
public class btBroadphasePairArray extends BulletBase {
	...
	public com.badlogic.gdx.utils.Array<btCollisionObject> getCollisionObjects (
		final com.badlogic.gdx.utils.Array<btCollisionObject> out, final btCollisionObject other, final int[] tempArray) {
	...
	/** Fills the given array with user value set using {@link btCollisionObject#setUserValue(int)} of the collision objects within
	 * this pair array colliding with the given collision object.
