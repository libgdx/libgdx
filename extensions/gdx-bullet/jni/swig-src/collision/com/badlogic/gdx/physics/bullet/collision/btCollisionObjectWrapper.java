...
public class btCollisionObjectWrapper extends BulletBase {
	...
	/** Construct a new btCollisionObjectWrapper, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	private static btCollisionObjectWrapper[] argumentInstances = new btCollisionObjectWrapper[] {
		new btCollisionObjectWrapper(0, false), new btCollisionObjectWrapper(0, false), new btCollisionObjectWrapper(0, false),
		new btCollisionObjectWrapper(0, false)};
