...
public class btConvexPointCloudShape extends btPolyhedralConvexAabbCachingShape {
	...
	/** Construct a new btConvexPointCloudShape, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public long operatorNew (long sizeInBytes) {
		return CollisionJNI.btConvexPointCloudShape_operatorNew__SWIG_0(swigCPtr, this, sizeInBytes);
	}

	public void operatorDelete (long ptr) {
		CollisionJNI.btConvexPointCloudShape_operatorDelete__SWIG_0(swigCPtr, this, ptr);
	}

	public long operatorNew (long arg0, long ptr) {
		return CollisionJNI.btConvexPointCloudShape_operatorNew__SWIG_1(swigCPtr, this, arg0, ptr);
	}

	public void operatorDelete (long arg0, long arg1) {
		CollisionJNI.btConvexPointCloudShape_operatorDelete__SWIG_1(swigCPtr, this, arg0, arg1);
	}

	public long operatorNewArray (long sizeInBytes) {
		return CollisionJNI.btConvexPointCloudShape_operatorNewArray__SWIG_0(swigCPtr, this, sizeInBytes);
	}

	public void operatorDeleteArray (long ptr) {
		CollisionJNI.btConvexPointCloudShape_operatorDeleteArray__SWIG_0(swigCPtr, this, ptr);
	}

	public long operatorNewArray (long arg0, long ptr) {
		return CollisionJNI.btConvexPointCloudShape_operatorNewArray__SWIG_1(swigCPtr, this, arg0, ptr);
	}

	public void operatorDeleteArray (long arg0, long arg1) {
		CollisionJNI.btConvexPointCloudShape_operatorDeleteArray__SWIG_1(swigCPtr, this, arg0, arg1);
	}
	...
	public btConvexPointCloudShape (btVector3 points, int numPoints, Vector3 localScaling, boolean computeAabb) {
		this(CollisionJNI.new_btConvexPointCloudShape__SWIG_1(btVector3.getCPtr(points), points, numPoints, localScaling,
			computeAabb), true);
	}
	...
	public void setPoints (btVector3 points, int numPoints, boolean computeAabb, Vector3 localScaling) {
		CollisionJNI.btConvexPointCloudShape_setPoints__SWIG_0(swigCPtr, this, btVector3.getCPtr(points), points, numPoints,
			computeAabb, localScaling);
	}

	public void setPoints (btVector3 points, int numPoints, boolean computeAabb) {
		CollisionJNI.btConvexPointCloudShape_setPoints__SWIG_1(swigCPtr, this, btVector3.getCPtr(points), points, numPoints,
			computeAabb);
	}
	...
	public btVector3 getUnscaledPoints () {
		long cPtr = CollisionJNI.btConvexPointCloudShape_getUnscaledPoints(swigCPtr, this);
		return (cPtr == 0) ? null : new btVector3(cPtr, false);
	}

	public btVector3 getUnscaledPointsConst () {
		long cPtr = CollisionJNI.btConvexPointCloudShape_getUnscaledPointsConst(swigCPtr, this);
		return (cPtr == 0) ? null : new btVector3(cPtr, false);
	}
