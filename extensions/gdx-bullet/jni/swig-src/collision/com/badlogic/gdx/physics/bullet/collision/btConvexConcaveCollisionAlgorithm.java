...
public class btConvexConcaveCollisionAlgorithm extends btActivatingCollisionAlgorithm {
	...
	/** Construct a new btConvexConcaveCollisionAlgorithm, normally you should not need this constructor it's intended for
	 * low-level usage. */
	...
	public btConvexConcaveCollisionAlgorithm (btCollisionAlgorithmConstructionInfo ci, btCollisionObjectWrapper body0Wrap,
		btCollisionObjectWrapper body1Wrap, boolean isSwapped) {
		this(CollisionJNI.new_btConvexConcaveCollisionAlgorithm(btCollisionAlgorithmConstructionInfo.getCPtr(ci), ci,
