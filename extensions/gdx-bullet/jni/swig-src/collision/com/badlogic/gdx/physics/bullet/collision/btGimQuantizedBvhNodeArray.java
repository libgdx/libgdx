...
public class btGimQuantizedBvhNodeArray extends BulletBase {
	...
	/** Construct a new btGimQuantizedBvhNodeArray, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btGimQuantizedBvhNodeArray operatorAssignment (btGimQuantizedBvhNodeArray other) {
		return new btGimQuantizedBvhNodeArray(CollisionJNI.btGimQuantizedBvhNodeArray_operatorAssignment(swigCPtr, this,
			btGimQuantizedBvhNodeArray.getCPtr(other), other), false);
	}
	...
	public void resize (int newsize, BT_QUANTIZED_BVH_NODE fillData) {
		CollisionJNI.btGimQuantizedBvhNodeArray_resize__SWIG_0(swigCPtr, this, newsize, BT_QUANTIZED_BVH_NODE.getCPtr(fillData),
			fillData);
	}
	...
	public BT_QUANTIZED_BVH_NODE expand (BT_QUANTIZED_BVH_NODE fillValue) {
		return new BT_QUANTIZED_BVH_NODE(CollisionJNI.btGimQuantizedBvhNodeArray_expand__SWIG_0(swigCPtr, this,
			BT_QUANTIZED_BVH_NODE.getCPtr(fillValue), fillValue), false);
	}
	...
	public void copyFromArray (btGimQuantizedBvhNodeArray otherArray) {
		CollisionJNI.btGimQuantizedBvhNodeArray_copyFromArray(swigCPtr, this, btGimQuantizedBvhNodeArray.getCPtr(otherArray),
			otherArray);
	}
