...
public class btMultiSapBroadphase extends btBroadphaseInterface {
  ...
  public void addToChildBroadphase(SWIGTYPE_p_btMultiSapBroadphase__btMultiSapProxy parentMultiSapProxy, btBroadphaseProxy childProxy, btBroadphaseInterface childBroadphase) {
    CollisionJNI.btMultiSapBroadphase_addToChildBroadphase(swigCPtr, this, SWIGTYPE_p_btMultiSapBroadphase__btMultiSapProxy.getCPtr(parentMultiSapProxy), btBroadphaseProxy.getCPtr(childProxy), childProxy, btBroadphaseInterface.getCPtr(childBroadphase), childBroadphase);
  }
