...
public class btCollisionObjectArray extends BulletBase {
	...
	public btCollisionObjectArray operatorAssignment (btCollisionObjectArray other) {
		return new btCollisionObjectArray(
			CollisionJNI.btCollisionObjectArray_operatorAssignment(swigCPtr, this, btCollisionObjectArray.getCPtr(other), other),
			false);
	}
	...
	public SWIGTYPE_p_p_btCollisionObject expand (btCollisionObject fillValue) {
		return new SWIGTYPE_p_p_btCollisionObject(
			CollisionJNI.btCollisionObjectArray_expand__SWIG_0(swigCPtr, this, btCollisionObject.getCPtr(fillValue), fillValue),
			false);
	}
	...
	static public class less extends BulletBase {
		...
		public boolean operatorFunctionCall (btCollisionObject a, btCollisionObject b) {
			return CollisionJNI.btCollisionObjectArray_less_operatorFunctionCall(swigCPtr, this, btCollisionObject.getCPtr(a), a,
				btCollisionObject.getCPtr(b), b);
		}
