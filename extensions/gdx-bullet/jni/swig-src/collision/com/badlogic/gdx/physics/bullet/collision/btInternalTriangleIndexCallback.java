...
public class btInternalTriangleIndexCallback extends BulletBase {
	...
	/** Construct a new btInternalTriangleIndexCallback, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void internalProcessTriangleIndex (btVector3 triangle, int partId, int triangleIndex) {
		CollisionJNI.btInternalTriangleIndexCallback_internalProcessTriangleIndex(swigCPtr, this, btVector3.getCPtr(triangle),
