...
public class btSphereSphereCollisionAlgorithm extends btActivatingCollisionAlgorithm {
	...
	/** Construct a new btSphereSphereCollisionAlgorithm, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btSphereSphereCollisionAlgorithm (btPersistentManifold mf, btCollisionAlgorithmConstructionInfo ci,
		...
		this(CollisionJNI.new_btSphereSphereCollisionAlgorithm__SWIG_0(btPersistentManifold.getCPtr(mf), mf,
			btCollisionAlgorithmConstructionInfo.getCPtr(ci), ci, btCollisionObjectWrapper.getCPtr(col0Wrap), col0Wrap,
			btCollisionObjectWrapper.getCPtr(col1Wrap), col1Wrap), true);
	}
