...
public class ClosestNotMeConvexResultCallback extends ClosestConvexResultCallback {
	...
	/** Construct a new ClosestNotMeConvexResultCallback, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public boolean needsCollision (btBroadphaseProxy proxy0) {
		return CollisionJNI.ClosestNotMeConvexResultCallback_needsCollision(swigCPtr, this, btBroadphaseProxy.getCPtr(proxy0),
			proxy0);
	}
