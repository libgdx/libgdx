...
public class btGimPairArray extends BulletBase {
	...
	public btGimPairArray operatorAssignment (btGimPairArray other) {
		return new btGimPairArray(
			CollisionJNI.btGimPairArray_operatorAssignment(swigCPtr, this, btGimPairArray.getCPtr(other), other), false);
	}
	...
	public GIM_PAIR expand (GIM_PAIR fillValue) {
		return new GIM_PAIR(CollisionJNI.btGimPairArray_expand__SWIG_0(swigCPtr, this, GIM_PAIR.getCPtr(fillValue), fillValue),
			false);
	}
