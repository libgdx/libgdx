...
public class btDbvt extends BulletBase {
  ...
  public static int allocate(btIntArray ifree, SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNPS_t stock, btDbvt.sStkNPS value) {
    return CollisionJNI.btDbvt_allocate(btIntArray.getCPtr(ifree), ifree, SWIGTYPE_p_btAlignedObjectArrayT_btDbvt__sStkNPS_t.getCPtr(stock), btDbvt.sStkNPS.getCPtr(value), value);
  }
