...
public class GIM_RSORT_TOKEN_COMPARATOR extends BulletBase {
	...
	/** Construct a new GIM_RSORT_TOKEN_COMPARATOR, normally you should not need this constructor it's intended for low-level usage. */ 
  ...
  public int operatorFunctionCall(GIM_RSORT_TOKEN a, GIM_RSORT_TOKEN b) {
    return CollisionJNI.GIM_RSORT_TOKEN_COMPARATOR_operatorFunctionCall(swigCPtr, this, GIM_RSORT_TOKEN.getCPtr(a), a, GIM_RSORT_TOKEN.getCPtr(b), b);
  }
