...
public class btCollisionObjectConstArray extends BulletBase {
	...
	/** Construct a new btCollisionObjectConstArray, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btCollisionObjectConstArray operatorAssignment (btCollisionObjectConstArray other) {
		return new btCollisionObjectConstArray(CollisionJNI.btCollisionObjectConstArray_operatorAssignment(swigCPtr, this,
			btCollisionObjectConstArray.getCPtr(other), other), false);
	}
	...
	public btCollisionObjectConstArray (btCollisionObjectConstArray otherArray) {
		this(CollisionJNI.new_btCollisionObjectConstArray__SWIG_1(btCollisionObjectConstArray.getCPtr(otherArray), otherArray),
			true);
	}
	...
	public btCollisionObject operatorSubscriptConst (int n) {
		return btCollisionObject.getInstance(CollisionJNI.btCollisionObjectConstArray_operatorSubscriptConst(swigCPtr, this, n),
			false);
	}

	public SWIGTYPE_p_p_btCollisionObject operatorSubscript (int n) {
		return new SWIGTYPE_p_p_btCollisionObject(CollisionJNI.btCollisionObjectConstArray_operatorSubscript(swigCPtr, this, n),
			false);
	}
	...
	public void resize (int newsize, btCollisionObject fillData) {
		CollisionJNI.btCollisionObjectConstArray_resize__SWIG_0(swigCPtr, this, newsize, btCollisionObject.getCPtr(fillData),
			fillData);
	}
	...
	public SWIGTYPE_p_p_btCollisionObject expandNonInitializing () {
		return new SWIGTYPE_p_p_btCollisionObject(CollisionJNI.btCollisionObjectConstArray_expandNonInitializing(swigCPtr, this),
			false);
	}

	public SWIGTYPE_p_p_btCollisionObject expand (btCollisionObject fillValue) {
		return new SWIGTYPE_p_p_btCollisionObject(
			CollisionJNI.btCollisionObjectConstArray_expand__SWIG_0(swigCPtr, this, btCollisionObject.getCPtr(fillValue), fillValue),
			false);
	}
	...
	static public class less extends BulletBase {
		...
		public boolean operatorFunctionCall (btCollisionObject a, btCollisionObject b) {
			return CollisionJNI.btCollisionObjectConstArray_less_operatorFunctionCall(swigCPtr, this, btCollisionObject.getCPtr(a),
				a, btCollisionObject.getCPtr(b), b);
		}
	...
	public void copyFromArray (btCollisionObjectConstArray otherArray) {
		CollisionJNI.btCollisionObjectConstArray_copyFromArray(swigCPtr, this, btCollisionObjectConstArray.getCPtr(otherArray),
			otherArray);
	}
