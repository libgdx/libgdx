...
public class btGImpactMeshShapePart extends btGImpactShapeInterface {
	...
	static public class TrimeshPrimitiveManager extends btPrimitiveManagerBase {
		...
		/** Construct a new TrimeshPrimitiveManager, normally you should not need this constructor it's intended for low-level
		 * usage. */
		...
		public void setMeshInterface (btStridingMeshInterface value) {
			CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_meshInterface_set(swigCPtr, this,
				btStridingMeshInterface.getCPtr(value), value);
		}
		...
		public TrimeshPrimitiveManager (btGImpactMeshShapePart.TrimeshPrimitiveManager manager) {
			this(CollisionJNI.new_btGImpactMeshShapePart_TrimeshPrimitiveManager__SWIG_1(
				btGImpactMeshShapePart.TrimeshPrimitiveManager.getCPtr(manager), manager), true);
		}

		public TrimeshPrimitiveManager (btStridingMeshInterface meshInterface, int part) {
			this(CollisionJNI.new_btGImpactMeshShapePart_TrimeshPrimitiveManager__SWIG_2(
		...
		public void get_indices (int face_index, SWIGTYPE_p_unsigned_int i0, SWIGTYPE_p_unsigned_int i1,
			SWIGTYPE_p_unsigned_int i2) {
			CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_indices(swigCPtr, this, face_index,
				SWIGTYPE_p_unsigned_int.getCPtr(i0), SWIGTYPE_p_unsigned_int.getCPtr(i1), SWIGTYPE_p_unsigned_int.getCPtr(i2));
		}
		...
		public void get_bullet_triangle (int prim_index, btTriangleShapeEx triangle) {
			CollisionJNI.btGImpactMeshShapePart_TrimeshPrimitiveManager_get_bullet_triangle(swigCPtr, this, prim_index,
				btTriangleShapeEx.getCPtr(triangle), triangle);
		}
	...
	public btGImpactMeshShapePart (btStridingMeshInterface meshInterface, int part) {
		this(CollisionJNI.new_btGImpactMeshShapePart__SWIG_1(btStridingMeshInterface.getCPtr(meshInterface), meshInterface, part),
			true);
	}
