...
public class btSimulationIslandManager extends BulletBase {
	...
	/** Construct a new btSimulationIslandManager, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void updateActivationState (btCollisionWorld colWorld, btDispatcher dispatcher) {
		CollisionJNI.btSimulationIslandManager_updateActivationState(swigCPtr, this, btCollisionWorld.getCPtr(colWorld), colWorld,
	...
	public void findUnions (btDispatcher dispatcher, btCollisionWorld colWorld) {
		CollisionJNI.btSimulationIslandManager_findUnions(swigCPtr, this, btDispatcher.getCPtr(dispatcher), dispatcher,
	...
	static public class IslandCallback extends BulletBase {
		...
		public void processIsland (SWIGTYPE_p_p_btCollisionObject bodies, int numBodies,
			SWIGTYPE_p_p_btPersistentManifold manifolds, int numManifolds, int islandId) {
			CollisionJNI.btSimulationIslandManager_IslandCallback_processIsland(swigCPtr, this,
	...
	public void buildAndProcessIslands (btDispatcher dispatcher, btCollisionWorld collisionWorld,
		...
		CollisionJNI.btSimulationIslandManager_buildAndProcessIslands(swigCPtr, this, btDispatcher.getCPtr(dispatcher), dispatcher,
			btCollisionWorld.getCPtr(collisionWorld), collisionWorld, btSimulationIslandManager.IslandCallback.getCPtr(callback),
			callback);
	}

	public void buildIslands (btDispatcher dispatcher, btCollisionWorld colWorld) {
		CollisionJNI.btSimulationIslandManager_buildIslands(swigCPtr, this, btDispatcher.getCPtr(dispatcher), dispatcher,
			btCollisionWorld.getCPtr(colWorld), colWorld);
	}
