...
public class btQuantizedBvhFloatData extends BulletBase {
	...
	/** Construct a new btQuantizedBvhFloatData, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void setContiguousNodesPtr (btOptimizedBvhNodeFloatData value) {
		CollisionJNI.btQuantizedBvhFloatData_contiguousNodesPtr_set(swigCPtr, this, btOptimizedBvhNodeFloatData.getCPtr(value),
			value);
	}
	...
	public void setQuantizedContiguousNodesPtr (btQuantizedBvhNodeData value) {
		CollisionJNI.btQuantizedBvhFloatData_quantizedContiguousNodesPtr_set(swigCPtr, this, btQuantizedBvhNodeData.getCPtr(value),
			value);
	}
