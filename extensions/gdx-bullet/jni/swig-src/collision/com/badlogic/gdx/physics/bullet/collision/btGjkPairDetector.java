...
public class btGjkPairDetector extends btDiscreteCollisionDetectorInterface {
	...
	public btGjkPairDetector (btConvexShape objectA, btConvexShape objectB, btVoronoiSimplexSolver simplexSolver,
		btConvexPenetrationDepthSolver penetrationDepthSolver) {
		this(CollisionJNI.new_btGjkPairDetector__SWIG_0(btConvexShape.getCPtr(objectA), objectA, btConvexShape.getCPtr(objectB),
			objectB, btVoronoiSimplexSolver.getCPtr(simplexSolver), simplexSolver,
	...
	public btGjkPairDetector (btConvexShape objectA, btConvexShape objectB, int shapeTypeA, int shapeTypeB, float marginA,
		...
		this(CollisionJNI.new_btGjkPairDetector__SWIG_1(btConvexShape.getCPtr(objectA), objectA, btConvexShape.getCPtr(objectB),
			objectB, shapeTypeA, shapeTypeB, marginA, marginB, btVoronoiSimplexSolver.getCPtr(simplexSolver), simplexSolver,
			btConvexPenetrationDepthSolver.getCPtr(penetrationDepthSolver), penetrationDepthSolver), true);
	}
	...
	public void getClosestPoints (btDiscreteCollisionDetectorInterface.ClosestPointInput input,
		...
		CollisionJNI.btGjkPairDetector_getClosestPoints__SWIG_0(swigCPtr, this,
	...
	public void getClosestPoints (btDiscreteCollisionDetectorInterface.ClosestPointInput input,
		...
		CollisionJNI.btGjkPairDetector_getClosestPoints__SWIG_1(swigCPtr, this,
			btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input), input,
			btDiscreteCollisionDetectorInterface.Result.getCPtr(output), output, btIDebugDraw.getCPtr(debugDraw), debugDraw);
	}

	public void getClosestPointsNonVirtual (btDiscreteCollisionDetectorInterface.ClosestPointInput input,
		btDiscreteCollisionDetectorInterface.Result output, btIDebugDraw debugDraw) {
		CollisionJNI.btGjkPairDetector_getClosestPointsNonVirtual(swigCPtr, this,
			btDiscreteCollisionDetectorInterface.ClosestPointInput.getCPtr(input), input,
			btDiscreteCollisionDetectorInterface.Result.getCPtr(output), output, btIDebugDraw.getCPtr(debugDraw), debugDraw);
	}
	...
	public void setPenetrationDepthSolver (btConvexPenetrationDepthSolver penetrationDepthSolver) {
		CollisionJNI.btGjkPairDetector_setPenetrationDepthSolver(swigCPtr, this,
