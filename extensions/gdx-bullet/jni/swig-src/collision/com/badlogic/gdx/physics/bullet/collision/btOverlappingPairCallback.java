...
public class btOverlappingPairCallback extends BulletBase {
	...
	/** Construct a new btOverlappingPairCallback, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btBroadphasePair addOverlappingPair (btBroadphaseProxy proxy0, btBroadphaseProxy proxy1) {
		return btBroadphasePair.internalTemp(CollisionJNI.btOverlappingPairCallback_addOverlappingPair(swigCPtr, this,
	...
	public long removeOverlappingPair (btBroadphaseProxy proxy0, btBroadphaseProxy proxy1, btDispatcher dispatcher) {
		return CollisionJNI.btOverlappingPairCallback_removeOverlappingPair(swigCPtr, this, btBroadphaseProxy.getCPtr(proxy0),
	...
	public void removeOverlappingPairsContainingProxy (btBroadphaseProxy proxy0, btDispatcher dispatcher) {
		CollisionJNI.btOverlappingPairCallback_removeOverlappingPairsContainingProxy(swigCPtr, this,
