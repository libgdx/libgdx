...
public class BT_BOX_BOX_TRANSFORM_CACHE extends BulletBase {
	...
	/** Construct a new BT_BOX_BOX_TRANSFORM_CACHE, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public void setR1to0 (btMatrix3x3 value) {
		CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_R1to0_set(swigCPtr, this, btMatrix3x3.getCPtr(value), value);
	}

	public btMatrix3x3 getR1to0 () {
		long cPtr = CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_R1to0_get(swigCPtr, this);
		return (cPtr == 0) ? null : new btMatrix3x3(cPtr, false);
	}

	public void setAR (btMatrix3x3 value) {
		CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_AR_set(swigCPtr, this, btMatrix3x3.getCPtr(value), value);
	}

	public btMatrix3x3 getAR () {
		long cPtr = CollisionJNI.BT_BOX_BOX_TRANSFORM_CACHE_AR_get(swigCPtr, this);
		return (cPtr == 0) ? null : new btMatrix3x3(cPtr, false);
	}
