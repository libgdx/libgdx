...
public class btCollisionConfiguration extends BulletBase {
	...
	/** Construct a new btCollisionConfiguration, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btCollisionAlgorithmCreateFunc getClosestPointsAlgorithmCreateFunc (int proxyType0, int proxyType1) {
		long cPtr = CollisionJNI.btCollisionConfiguration_getClosestPointsAlgorithmCreateFunc(swigCPtr, this, proxyType0,
			proxyType1);
		return (cPtr == 0) ? null : new btCollisionAlgorithmCreateFunc(cPtr, false);
	}
