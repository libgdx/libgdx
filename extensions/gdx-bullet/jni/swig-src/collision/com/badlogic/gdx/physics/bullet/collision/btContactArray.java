...
public class btContactArray extends btGimContactArray {
	...
	public void push_triangle_contacts (GIM_TRIANGLE_CONTACT tricontact, int feature1, int feature2) {
		CollisionJNI.btContactArray_push_triangle_contacts(swigCPtr, this, GIM_TRIANGLE_CONTACT.getCPtr(tricontact), tricontact,
			feature1, feature2);
	}

	public void merge_contacts (btContactArray contacts, boolean normal_contact_average) {
		CollisionJNI.btContactArray_merge_contacts__SWIG_0(swigCPtr, this, btContactArray.getCPtr(contacts), contacts,
