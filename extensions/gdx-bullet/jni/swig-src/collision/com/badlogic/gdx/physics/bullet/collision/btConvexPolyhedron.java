...
public class btConvexPolyhedron extends BulletBase {
  ...
  public void setFaces(btFaceArray value) {
    CollisionJNI.btConvexPolyhedron_faces_set(swigCPtr, this, btFaceArray.getCPtr(value), value);
  }

  public btFaceArray getFaces() {
    long cPtr = CollisionJNI.btConvexPolyhedron_faces_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btFaceArray(cPtr, false);
  }
