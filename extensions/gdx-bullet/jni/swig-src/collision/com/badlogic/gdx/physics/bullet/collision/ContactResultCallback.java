...
public class ContactResultCallback extends BulletBase {
	...
	public boolean needsCollision (btBroadphaseProxy proxy0) {
		return (getClass() == ContactResultCallback.class)
			? CollisionJNI.ContactResultCallback_needsCollision(swigCPtr, this, btBroadphaseProxy.getCPtr(proxy0), proxy0)
			: CollisionJNI.ContactResultCallback_needsCollisionSwigExplicitContactResultCallback(swigCPtr, this,
	...
	public float addSingleResult (btManifoldPoint cp, btCollisionObjectWrapper colObj0Wrap, int partId0, int index0,
		...
		return CollisionJNI.ContactResultCallback_addSingleResult(swigCPtr, this, btManifoldPoint.getCPtr(cp), cp,
