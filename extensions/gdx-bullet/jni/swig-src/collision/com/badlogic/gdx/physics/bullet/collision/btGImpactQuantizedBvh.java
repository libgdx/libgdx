...
public class btGImpactQuantizedBvh extends BulletBase {
  ...
  public boolean boxQuery(btAABB box, btIntArray collided_results) {
    return CollisionJNI.btGImpactQuantizedBvh_boxQuery(swigCPtr, this, btAABB.getCPtr(box), box, btIntArray.getCPtr(collided_results), collided_results);
  }

  public boolean boxQueryTrans(btAABB box, Matrix4 transform, btIntArray collided_results) {
    return CollisionJNI.btGImpactQuantizedBvh_boxQueryTrans(swigCPtr, this, btAABB.getCPtr(box), box, transform, btIntArray.getCPtr(collided_results), collided_results);
  }

  public boolean rayQuery(Vector3 ray_dir, Vector3 ray_origin, btIntArray collided_results) {
    return CollisionJNI.btGImpactQuantizedBvh_rayQuery(swigCPtr, this, ray_dir, ray_origin, btIntArray.getCPtr(collided_results), collided_results);
  }
