...
public class btCollisionWorldImporter extends BulletBase {
	...
	/** Construct a new btCollisionWorldImporter, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public boolean convertAllObjects (btBulletSerializedArrays arrays) {
		return CollisionJNI.btCollisionWorldImporter_convertAllObjects(swigCPtr, this, btBulletSerializedArrays.getCPtr(arrays),
			arrays);
	}
	...
	public btCollisionObject getRigidBodyByIndex (int index) {
		return btCollisionObject.getInstance(CollisionJNI.btCollisionWorldImporter_getRigidBodyByIndex(swigCPtr, this, index),
			false);
	}
	...
	public btCollisionObject getCollisionObjectByName (String name) {
		return btCollisionObject.getInstance(CollisionJNI.btCollisionWorldImporter_getCollisionObjectByName(swigCPtr, this, name),
			false);
	}
	...
	public btCollisionObject createCollisionObject (Matrix4 startTransform, btCollisionShape shape, String bodyName) {
		return btCollisionObject.getInstance(CollisionJNI.btCollisionWorldImporter_createCollisionObject(swigCPtr, this,
			startTransform, btCollisionShape.getCPtr(shape), shape, bodyName), false);
	}
	...
	public btBvhTriangleMeshShape createBvhTriangleMeshShape (btStridingMeshInterface trimesh, btOptimizedBvh bvh) {
		long cPtr = CollisionJNI.btCollisionWorldImporter_createBvhTriangleMeshShape(swigCPtr, this,
			btStridingMeshInterface.getCPtr(trimesh), trimesh, btOptimizedBvh.getCPtr(bvh), bvh);
	...
	public btCollisionShape createConvexTriangleMeshShape (btStridingMeshInterface trimesh) {
		long cPtr = CollisionJNI.btCollisionWorldImporter_createConvexTriangleMeshShape(swigCPtr, this,
	...
	public btStridingMeshInterfaceData createStridingMeshInterfaceData (btStridingMeshInterfaceData interfaceData) {
		long cPtr = CollisionJNI.btCollisionWorldImporter_createStridingMeshInterfaceData(swigCPtr, this,
	...
	public btScaledBvhTriangleMeshShape createScaledTrangleMeshShape (btBvhTriangleMeshShape meshShape,
		...
		long cPtr = CollisionJNI.btCollisionWorldImporter_createScaledTrangleMeshShape(swigCPtr, this,
	...
	public btMultiSphereShape createMultiSphereShape (btVector3 positions, java.nio.FloatBuffer radi, int numSpheres) {
		...
		{
			long cPtr = CollisionJNI.btCollisionWorldImporter_createMultiSphereShape(swigCPtr, this, btVector3.getCPtr(positions),
	...
	public btTriangleIndexVertexArray createMeshInterface (btStridingMeshInterfaceData meshData) {
		long cPtr = CollisionJNI.btCollisionWorldImporter_createMeshInterface(swigCPtr, this,
			btStridingMeshInterfaceData.getCPtr(meshData), meshData);
		return (cPtr == 0) ? null : new btTriangleIndexVertexArray(cPtr, false);
	}
