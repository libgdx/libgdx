...
public class btBroadphaseInterface extends BulletBase {
	...
	public btBroadphaseProxy createProxy (Vector3 aabbMin, Vector3 aabbMax, int shapeType, long userPtr, int collisionFilterGroup,
		int collisionFilterMask, btDispatcher dispatcher) {
		return btBroadphaseProxy.internalTemp(CollisionJNI.btBroadphaseInterface_createProxy(swigCPtr, this, aabbMin, aabbMax,
			shapeType, userPtr, collisionFilterGroup, collisionFilterMask, btDispatcher.getCPtr(dispatcher), dispatcher), false);
	}

	public void destroyProxy (btBroadphaseProxy proxy, btDispatcher dispatcher) {
		CollisionJNI.btBroadphaseInterface_destroyProxy(swigCPtr, this, btBroadphaseProxy.getCPtr(proxy), proxy,
	...
	public void setAabb (btBroadphaseProxy proxy, Vector3 aabbMin, Vector3 aabbMax, btDispatcher dispatcher) {
		CollisionJNI.btBroadphaseInterface_setAabb(swigCPtr, this, btBroadphaseProxy.getCPtr(proxy), proxy, aabbMin, aabbMax,
			btDispatcher.getCPtr(dispatcher), dispatcher);
	}
	...
	public void rayTest (Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback, Vector3 aabbMin, Vector3 aabbMax) {
		CollisionJNI.btBroadphaseInterface_rayTest__SWIG_0(swigCPtr, this, rayFrom, rayTo,
	...
	public void rayTest (Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback, Vector3 aabbMin) {
		CollisionJNI.btBroadphaseInterface_rayTest__SWIG_1(swigCPtr, this, rayFrom, rayTo,
	...
	public void rayTest (Vector3 rayFrom, Vector3 rayTo, btBroadphaseRayCallback rayCallback) {
		CollisionJNI.btBroadphaseInterface_rayTest__SWIG_2(swigCPtr, this, rayFrom, rayTo,
	...
	public void aabbTest (Vector3 aabbMin, Vector3 aabbMax, btBroadphaseAabbCallback callback) {
		CollisionJNI.btBroadphaseInterface_aabbTest(swigCPtr, this, aabbMin, aabbMax, btBroadphaseAabbCallback.getCPtr(callback),
			callback);
	}
