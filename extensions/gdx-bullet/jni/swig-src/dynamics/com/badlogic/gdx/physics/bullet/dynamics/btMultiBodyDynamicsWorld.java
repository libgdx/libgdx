...
public class btMultiBodyDynamicsWorld extends btDiscreteDynamicsWorld {
	...
	/** Construct a new btMultiBodyDynamicsWorld, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btMultiBodyDynamicsWorld (btDispatcher dispatcher, btBroadphaseInterface pairCache,
		btMultiBodyConstraintSolver constraintSolver, btCollisionConfiguration collisionConfiguration) {
		this(DynamicsJNI.new_btMultiBodyDynamicsWorld(btDispatcher.getCPtr(dispatcher), dispatcher,
	...
	public void addMultiBodyConstraint (btMultiBodyConstraint constraint) {
		DynamicsJNI.btMultiBodyDynamicsWorld_addMultiBodyConstraint(swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint),
			constraint);
	}
	...
	public void removeMultiBodyConstraint (btMultiBodyConstraint constraint) {
		DynamicsJNI.btMultiBodyDynamicsWorld_removeMultiBodyConstraint(swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint),
			constraint);
	}
	...
	public void debugDrawMultiBodyConstraint (btMultiBodyConstraint constraint) {
		DynamicsJNI.btMultiBodyDynamicsWorld_debugDrawMultiBodyConstraint(swigCPtr, this, btMultiBodyConstraint.getCPtr(constraint),
			constraint);
	}
