...
public class btDiscreteDynamicsWorld extends btDynamicsWorld {
	...
	/** Construct a new btDiscreteDynamicsWorld, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public long operatorNew (long sizeInBytes) {
		return DynamicsJNI.btDiscreteDynamicsWorld_operatorNew__SWIG_0(swigCPtr, this, sizeInBytes);
	}

	public void operatorDelete (long ptr) {
		DynamicsJNI.btDiscreteDynamicsWorld_operatorDelete__SWIG_0(swigCPtr, this, ptr);
	}

	public long operatorNew (long arg0, long ptr) {
		return DynamicsJNI.btDiscreteDynamicsWorld_operatorNew__SWIG_1(swigCPtr, this, arg0, ptr);
	}

	public void operatorDelete (long arg0, long arg1) {
		DynamicsJNI.btDiscreteDynamicsWorld_operatorDelete__SWIG_1(swigCPtr, this, arg0, arg1);
	}

	public long operatorNewArray (long sizeInBytes) {
		return DynamicsJNI.btDiscreteDynamicsWorld_operatorNewArray__SWIG_0(swigCPtr, this, sizeInBytes);
	}

	public void operatorDeleteArray (long ptr) {
		DynamicsJNI.btDiscreteDynamicsWorld_operatorDeleteArray__SWIG_0(swigCPtr, this, ptr);
	}

	public long operatorNewArray (long arg0, long ptr) {
		return DynamicsJNI.btDiscreteDynamicsWorld_operatorNewArray__SWIG_1(swigCPtr, this, arg0, ptr);
	}

	public void operatorDeleteArray (long arg0, long arg1) {
		DynamicsJNI.btDiscreteDynamicsWorld_operatorDeleteArray__SWIG_1(swigCPtr, this, arg0, arg1);
	}
	...
	public btDiscreteDynamicsWorld (btDispatcher dispatcher, btBroadphaseInterface pairCache, btConstraintSolver constraintSolver,
		...
		this(DynamicsJNI.new_btDiscreteDynamicsWorld(btDispatcher.getCPtr(dispatcher), dispatcher,
	...
	public void addConstraint (btTypedConstraint constraint, boolean disableCollisionsBetweenLinkedBodies) {
		DynamicsJNI.btDiscreteDynamicsWorld_addConstraint__SWIG_0(swigCPtr, this, btTypedConstraint.getCPtr(constraint), constraint,
			disableCollisionsBetweenLinkedBodies);
	}

	public void addConstraint (btTypedConstraint constraint) {
		DynamicsJNI.btDiscreteDynamicsWorld_addConstraint__SWIG_1(swigCPtr, this, btTypedConstraint.getCPtr(constraint),
			constraint);
	}

	public btSimulationIslandManager getSimulationIslandManager () {
		long cPtr = DynamicsJNI.btDiscreteDynamicsWorld_getSimulationIslandManager(swigCPtr, this);
	...
	public btSimulationIslandManager getSimulationIslandManagerConst () {
		long cPtr = DynamicsJNI.btDiscreteDynamicsWorld_getSimulationIslandManagerConst(swigCPtr, this);
		return (cPtr == 0) ? null : new btSimulationIslandManager(cPtr, false);
	}
	...
	public void addCollisionObject (btCollisionObject collisionObject, int collisionFilterGroup, int collisionFilterMask) {
		DynamicsJNI.btDiscreteDynamicsWorld_addCollisionObject__SWIG_0(swigCPtr, this, btCollisionObject.getCPtr(collisionObject),
	...
	public void addCollisionObject (btCollisionObject collisionObject, int collisionFilterGroup) {
		DynamicsJNI.btDiscreteDynamicsWorld_addCollisionObject__SWIG_1(swigCPtr, this, btCollisionObject.getCPtr(collisionObject),
			collisionObject, collisionFilterGroup);
	}

	public void addCollisionObject (btCollisionObject collisionObject) {
		DynamicsJNI.btDiscreteDynamicsWorld_addCollisionObject__SWIG_2(swigCPtr, this, btCollisionObject.getCPtr(collisionObject),
			collisionObject);
	}
