...
public class btLemkeAlgorithm extends BulletBase {
	...
	public btLemkeAlgorithm (SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_, int DEBUGLEVEL_) {
		this(DynamicsJNI.new_btLemkeAlgorithm__SWIG_0(SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_),
			SWIGTYPE_p_btVectorXT_float_t.getCPtr(q_), DEBUGLEVEL_), true);
	}

	public btLemkeAlgorithm (SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_) {
		this(DynamicsJNI.new_btLemkeAlgorithm__SWIG_1(SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_),
			SWIGTYPE_p_btVectorXT_float_t.getCPtr(q_)), true);
	}
	...
	public void setSystem (SWIGTYPE_p_btMatrixXT_float_t M_, SWIGTYPE_p_btVectorXT_float_t q_) {
		DynamicsJNI.btLemkeAlgorithm_setSystem(swigCPtr, this, SWIGTYPE_p_btMatrixXT_float_t.getCPtr(M_),
			SWIGTYPE_p_btVectorXT_float_t.getCPtr(q_));
	}
