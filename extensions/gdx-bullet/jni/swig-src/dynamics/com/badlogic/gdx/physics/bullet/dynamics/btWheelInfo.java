...
public class btWheelInfo extends BulletBase {
  ...
  public void setRaycastInfo(SWIGTYPE_p_btWheelInfo__RaycastInfo value) {
    DynamicsJNI.btWheelInfo_raycastInfo_set(swigCPtr, this, SWIGTYPE_p_btWheelInfo__RaycastInfo.getCPtr(value));
  }
  ...
  public void updateWheel(btRigidBody chassis, SWIGTYPE_p_btWheelInfo__RaycastInfo raycastInfo) {
    DynamicsJNI.btWheelInfo_updateWheel(swigCPtr, this, btRigidBody.getCPtr(chassis), chassis, SWIGTYPE_p_btWheelInfo__RaycastInfo.getCPtr(raycastInfo));
  }
