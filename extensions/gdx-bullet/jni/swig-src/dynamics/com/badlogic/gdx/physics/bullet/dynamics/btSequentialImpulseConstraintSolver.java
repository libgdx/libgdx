...
public class btSequentialImpulseConstraintSolver extends btConstraintSolver {
	...
	/** Construct a new btSequentialImpulseConstraintSolver, normally you should not need this constructor it's intended for
	 * low-level usage. */
	...
	public SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar getActiveConstraintRowSolverGeneric () {
		...
		return (cPtr == 0) ? null
			: new SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar(cPtr, false);
	}

	public void setConstraintRowSolverGeneric (
		SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar rowSolver) {
		DynamicsJNI.btSequentialImpulseConstraintSolver_setConstraintRowSolverGeneric(swigCPtr, this,
			SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar.getCPtr(rowSolver));
	}
	...
	public void setConstraintRowSolverLowerLimit (
		SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar rowSolver) {
		DynamicsJNI.btSequentialImpulseConstraintSolver_setConstraintRowSolverLowerLimit(swigCPtr, this,
			SWIGTYPE_p_f_r_btSolverBody_r_btSolverBody_r_q_const__btSolverConstraint__btSimdScalar.getCPtr(rowSolver));
	}
