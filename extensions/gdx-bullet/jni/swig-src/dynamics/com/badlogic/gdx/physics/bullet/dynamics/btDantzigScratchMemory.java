...
public class btDantzigScratchMemory extends BulletBase {
  ...
  public void setP(btIntArray value) {
    DynamicsJNI.btDantzigScratchMemory_p_set(swigCPtr, this, btIntArray.getCPtr(value), value);
  }

  public btIntArray getP() {
    long cPtr = DynamicsJNI.btDantzigScratchMemory_p_get(swigCPtr, this);
    return (cPtr == 0) ? null : new btIntArray(cPtr, false);
  }

  public void setC(btIntArray value) {
    DynamicsJNI.btDantzigScratchMemory_C_set(swigCPtr, this, btIntArray.getCPtr(value), value);
  }

  public btIntArray getC() {
