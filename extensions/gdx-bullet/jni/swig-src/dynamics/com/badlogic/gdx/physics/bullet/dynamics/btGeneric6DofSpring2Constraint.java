...
public class btGeneric6DofSpring2Constraint extends btTypedConstraint {
  ...
  public void setStiffness(int index, float stiffness) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setStiffness(swigCPtr, this, index, stiffness);
  }

  public void setDamping(int index, float damping) {
    DynamicsJNI.btGeneric6DofSpring2Constraint_setDamping(swigCPtr, this, index, damping);
  }
