...
public class btPoint2PointConstraint extends btTypedConstraint {
  ...
  public void getInfo1NonVirtual(SWIGTYPE_p_btTypedConstraint__btConstraintInfo1 info) {
    DynamicsJNI.btPoint2PointConstraint_getInfo1NonVirtual(swigCPtr, this, SWIGTYPE_p_btTypedConstraint__btConstraintInfo1.getCPtr(info));
  }

  public void getInfo2NonVirtual(btConstraintInfo2 info, Matrix4 body0_trans, Matrix4 body1_trans) {
    DynamicsJNI.btPoint2PointConstraint_getInfo2NonVirtual(swigCPtr, this, btConstraintInfo2.getCPtr(info), info, body0_trans, body1_trans);
  }
