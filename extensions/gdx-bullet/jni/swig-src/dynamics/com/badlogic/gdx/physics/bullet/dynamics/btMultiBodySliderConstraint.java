...
public class btMultiBodySliderConstraint extends btMultiBodyConstraint {
	...
	/** Construct a new btMultiBodySliderConstraint, normally you should not need this constructor it's intended for low-level
	 * usage. */
	...
	public btMultiBodySliderConstraint (btMultiBody body, int link, btRigidBody bodyB, Vector3 pivotInA, Vector3 pivotInB,
		Matrix3 frameInA, Matrix3 frameInB, Vector3 jointAxis) {
		this(DynamicsJNI.new_btMultiBodySliderConstraint__SWIG_0(btMultiBody.getCPtr(body), body, link, btRigidBody.getCPtr(bodyB),
			bodyB, pivotInA, pivotInB, frameInA, frameInB, jointAxis), true);
	}

	public btMultiBodySliderConstraint (btMultiBody bodyA, int linkA, btMultiBody bodyB, int linkB, Vector3 pivotInA,
		Vector3 pivotInB, Matrix3 frameInA, Matrix3 frameInB, Vector3 jointAxis) {
		this(DynamicsJNI.new_btMultiBodySliderConstraint__SWIG_1(btMultiBody.getCPtr(bodyA), bodyA, linkA,
			btMultiBody.getCPtr(bodyB), bodyB, linkB, pivotInA, pivotInB, frameInA, frameInB, jointAxis), true);
	}
