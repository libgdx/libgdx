...
public class btUniformScalingShape extends btConvexShape {
	...
	protected btUniformScalingShape(final String className, long cPtr, boolean cMemoryOwn) {
		super(className, gdxBulletJNI.btUniformScalingShape_SWIGUpcast(cPtr), cMemoryOwn);
		swigCPtr = cPtr;
	}
	...
	protected void reset(long cPtr, boolean cMemoryOwn) {
		if (!destroyed)
			destroy();
		super.reset(gdxBulletJNI.btUniformScalingShape_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
	}
