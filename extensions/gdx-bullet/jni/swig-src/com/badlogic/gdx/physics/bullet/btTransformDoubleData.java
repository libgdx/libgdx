...
public class btTransformDoubleData extends BulletBase {
  ...
  public void setBasis(SWIGTYPE_p_btMatrix3x3DoubleData value) {
    gdxBulletJNI.btTransformDoubleData_basis_set(swigCPtr, this, SWIGTYPE_p_btMatrix3x3DoubleData.getCPtr(value));
  }

  public SWIGTYPE_p_btMatrix3x3DoubleData getBasis() {
    return new SWIGTYPE_p_btMatrix3x3DoubleData(gdxBulletJNI.btTransformDoubleData_basis_get(swigCPtr, this), true);
  }

  public void setOrigin(btVector3DoubleData value) {
    gdxBulletJNI.btTransformDoubleData_origin_set(swigCPtr, this, btVector3DoubleData.getCPtr(value), value);
  }

  public btVector3DoubleData getOrigin() {
    long cPtr = gdxBulletJNI.btTransformDoubleData_origin_get(swigCPtr, this);
