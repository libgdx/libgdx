...
public class Feature extends Element {
	...
	protected Feature(final String className, long cPtr, boolean cMemoryOwn) {
		super(className, gdxBulletJNI.Feature_SWIGUpcast(cPtr), cMemoryOwn);
		swigCPtr = cPtr;
	}
	...
	protected void reset(long cPtr, boolean cMemoryOwn) {
		if (!destroyed)
			destroy();
		super.reset(gdxBulletJNI.Feature_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
	}
  ...
  public void setMaterial(Material value) {
    gdxBulletJNI.Feature_material_set(swigCPtr, this, Material.getCPtr(value), value);
  }

  public Material getMaterial() {
    long cPtr = gdxBulletJNI.Feature_material_get(swigCPtr, this);
