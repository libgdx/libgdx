...
public class btVector4 extends btVector3 {
	...
	protected void reset(long cPtr, boolean cMemoryOwn) {
		if (!destroyed)
			destroy();
		super.reset(gdxBulletJNI.btVector4_SWIGUpcast(swigCPtr = cPtr), cMemoryOwn);
	}
  ...
  public btVector4(float _x, float _y, float _z, float _w) {
    this(gdxBulletJNI.new_btVector4__SWIG_1(_x, _y, _z, _w), true);
  }
  ...
  public void setValue(float _x, float _y, float _z, float _w) {
    gdxBulletJNI.btVector4_setValue(swigCPtr, this, _x, _y, _z, _w);
  }
