...
public class btSymmetricSpatialDyad extends BulletBase {
	...
	public btSymmetricSpatialDyad operatorSubtractionAssignment (btSymmetricSpatialDyad mat) {
		return new btSymmetricSpatialDyad(LinearMathJNI.btSymmetricSpatialDyad_operatorSubtractionAssignment(swigCPtr, this,
			btSymmetricSpatialDyad.getCPtr(mat), mat), false);
	}

	public btSpatialForceVector operatorMultiplication (btSpatialMotionVector vec) {
		return new btSpatialForceVector(
			LinearMathJNI.btSymmetricSpatialDyad_operatorMultiplication(swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
			true);
	}
