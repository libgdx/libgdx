...
public class btMatrix3x3 extends BulletBase {
	...
	public void getEulerYPR (SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll) {
		LinearMathJNI.btMatrix3x3_getEulerYPR(swigCPtr, this, SWIGTYPE_p_float.getCPtr(yaw), SWIGTYPE_p_float.getCPtr(pitch),
			SWIGTYPE_p_float.getCPtr(roll));
	}

	public void getEulerZYX (SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll, long solution_number) {
		LinearMathJNI.btMatrix3x3_getEulerZYX__SWIG_0(swigCPtr, this, SWIGTYPE_p_float.getCPtr(yaw),
			SWIGTYPE_p_float.getCPtr(pitch), SWIGTYPE_p_float.getCPtr(roll), solution_number);
	}

	public void getEulerZYX (SWIGTYPE_p_float yaw, SWIGTYPE_p_float pitch, SWIGTYPE_p_float roll) {
		LinearMathJNI.btMatrix3x3_getEulerZYX__SWIG_1(swigCPtr, this, SWIGTYPE_p_float.getCPtr(yaw),
			SWIGTYPE_p_float.getCPtr(pitch), SWIGTYPE_p_float.getCPtr(roll));
	}
