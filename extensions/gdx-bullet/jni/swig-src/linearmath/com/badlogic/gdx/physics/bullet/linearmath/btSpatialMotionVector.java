...
public class btSpatialMotionVector extends BulletBase {
	...
	public btSpatialMotionVector operatorAdditionAssignment (btSpatialMotionVector vec) {
		return new btSpatialMotionVector(
			LinearMathJNI.btSpatialMotionVector_operatorAdditionAssignment(swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
			false);
	}

	public btSpatialMotionVector operatorSubtractionAssignment (btSpatialMotionVector vec) {
		return new btSpatialMotionVector(LinearMathJNI.btSpatialMotionVector_operatorSubtractionAssignment(swigCPtr, this,
			btSpatialMotionVector.getCPtr(vec), vec), false);
	}

	public btSpatialMotionVector operatorMultiplicationAssignment (float s) {
		return new btSpatialMotionVector(LinearMathJNI.btSpatialMotionVector_operatorMultiplicationAssignment(swigCPtr, this, s),
			false);
	}

	public btSpatialMotionVector operatorSubtraction (btSpatialMotionVector vec) {
		return new btSpatialMotionVector(
			LinearMathJNI.btSpatialMotionVector_operatorSubtraction__SWIG_0(swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec),
			true);
	}

	public btSpatialMotionVector operatorAddition (btSpatialMotionVector vec) {
		return new btSpatialMotionVector(
			LinearMathJNI.btSpatialMotionVector_operatorAddition(swigCPtr, this, btSpatialMotionVector.getCPtr(vec), vec), true);
	}
