...
{
	SoftBodyMaterialData	*m_material;
	std::ptrdiff_t			m_nodeIndices[2];			// Node pointers
...
struct	SoftBodyFaceData
{
	...
	SoftBodyMaterialData	*m_material;
	std::ptrdiff_t			m_nodeIndices[3];			// Node pointers
...
struct	SoftBodyTetraData
{
	...
	SoftBodyMaterialData	*m_material;
	std::ptrdiff_t			m_nodeIndices[4];			// Node pointers		
...
struct	SoftRigidAnchorData
{
	...
	std::ptrdiff_t			m_nodeIndex;			// Node pointer
	float					m_c2;			// ima*dt
};
