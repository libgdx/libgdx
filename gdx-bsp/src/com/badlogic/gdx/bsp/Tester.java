...
import com.badlogic.gdx.bsp.collision.CollisionDetection;
import com.badlogic.gdx.bsp.collision.CollisionMesh;
import com.badlogic.gdx.bsp.collision.CollisionPacket;
import com.badlogic.gdx.bsp.collision.EllipsoidCollider;
import com.badlogic.gdx.bsp.collision.SlideResponse;
...
public class Tester implements RenderListener
{
	...
	public static void main( String[] argv )
	{
		...
		app.getGraphics().setRenderListener( new Tester() );
	}
}
